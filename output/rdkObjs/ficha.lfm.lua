...
local function constructNew_frmFichaDePersonagem()
    ...
    obj.habilidadesLayout:setParent(obj.scrollBox1);
    ...
    obj.flowLayout1:setParent(obj.habilidadesLayout);
    obj.flowLayout1:setAlign("top");
    obj.flowLayout1:setAutoHeight(true);
    obj.flowLayout1:setMaxControlsPerLine(1);
    obj.flowLayout1:setHorzAlign("center");
    obj.flowLayout1:setMaxWidth(406);
    ...
    obj.rectangle2:setStrokeColor("silver");
    ...
    obj.label1:setText("Habilidades Base");
    obj.label1:setFontSize(18);
    lfm_setPropAsString(obj.label1, "fontStyle",  "italic bold");
    ...
    obj.flowPart2:setWidth(16);
    obj.flowPart2:setHeight(20);
    obj.flowPart2:setLeft(375);
    obj.flowPart2:setTop(10);
    obj.flowPart2:setName("flowPart2");

    obj.button1 = GUI.fromHandle(_obj_newObject("button"));
    obj.button1:setParent(obj.flowPart2);
    obj.button1:setAlign("client");
    obj.button1:setHeight(16);
    obj.button1:setText("+");
    ...
    obj.rclHabilidadesbase:setParent(obj.flowLayout1);
    ...
    obj.flowLayout3:setParent(obj.habilidadesLayout);
    obj.flowLayout3:setAlign("top");
    obj.flowLayout3:setAutoHeight(true);
    obj.flowLayout3:setMaxControlsPerLine(1);
    obj.flowLayout3:setHorzAlign("center");
    obj.flowLayout3:setMaxWidth(406);
    obj.flowLayout3:setName("flowLayout3");

    obj.rectangle3 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle3:setParent(obj.flowLayout3);
    ...
    obj.flowLayout4:setParent(obj.rectangle3);
    ...
    obj.flowPart3:setWidth(75);
    obj.flowPart3:setVertAlign("center");
    obj.flowPart3:setAlign("client");
    obj.flowPart3:setMargins({top=10});
    obj.flowPart3:setName("flowPart3");

    obj.label2 = GUI.fromHandle(_obj_newObject("label"));
    obj.label2:setParent(obj.flowPart3);
    obj.label2:setText("Nível 1");
    obj.label2:setFontSize(18);
    lfm_setPropAsString(obj.label2, "fontStyle",  "italic bold");
    ...
    obj.flowPart4:setParent(obj.rectangle3);
    obj.flowPart4:setWidth(16);
    obj.flowPart4:setHeight(20);
    obj.flowPart4:setLeft(375);
    obj.flowPart4:setTop(10);
    obj.flowPart4:setName("flowPart4");

    obj.button2 = GUI.fromHandle(_obj_newObject("button"));
    obj.button2:setParent(obj.flowPart4);
    obj.button2:setAlign("client");
    obj.button2:setHeight(16);
    obj.button2:setText("+");
    ...
    obj.rclHabilidadesnivel1:setParent(obj.flowLayout3);
    ...
    obj.flowLayout5:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout5:setMaxWidth(406);
    ...
    obj.flowLayout6:setParent(obj.rectangle4);
    obj.flowLayout6:setWidth(400);
    obj.flowLayout6:setHeight(40);
    ...
    obj.flowPart5:setWidth(75);
    obj.flowPart5:setVertAlign("center");
    obj.flowPart5:setAlign("client");
    obj.flowPart5:setMargins({top=10});
    obj.flowPart5:setName("flowPart5");

    obj.label3 = GUI.fromHandle(_obj_newObject("label"));
    obj.label3:setParent(obj.flowPart5);
    obj.label3:setText("Nível 2");
    obj.label3:setFontSize(18);
    lfm_setPropAsString(obj.label3, "fontStyle",  "italic bold");
    obj.label3:setAlign("client");
    obj.label3:setHorzTextAlign("center");
    obj.label3:setName("label3");

    obj.horzLine3 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine3:setParent(obj.flowPart5);
    ...
    obj.flowPart6:setParent(obj.rectangle4);
    obj.flowPart6:setWidth(16);
    obj.flowPart6:setHeight(20);
    obj.flowPart6:setLeft(375);
    obj.flowPart6:setTop(10);
    obj.flowPart6:setName("flowPart6");

    obj.button3 = GUI.fromHandle(_obj_newObject("button"));
    obj.button3:setParent(obj.flowPart6);
    obj.button3:setAlign("client");
    obj.button3:setHeight(16);
    obj.button3:setText("+");
    ...
    obj.rclHabilidadesnivel2:setParent(obj.flowLayout5);
    ...
    obj.flowLayout7:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout8:setHeight(40);
    obj.flowLayout8:setMaxControlsPerLine(1);
    obj.flowLayout8:setHorzAlign("center");
    obj.flowLayout8:setName("flowLayout8");

    obj.flowPart7 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart7:setParent(obj.flowLayout8);
    obj.flowPart7:setHeight(20);
    obj.flowPart7:setWidth(75);
    obj.flowPart7:setVertAlign("center");
    obj.flowPart7:setAlign("client");
    obj.flowPart7:setMargins({top=10});
    obj.flowPart7:setName("flowPart7");

    obj.label4 = GUI.fromHandle(_obj_newObject("label"));
    obj.label4:setParent(obj.flowPart7);
    obj.label4:setText("Nível 3");
    obj.label4:setFontSize(18);
    lfm_setPropAsString(obj.label4, "fontStyle",  "italic bold");
    obj.label4:setAlign("client");
    obj.label4:setHorzTextAlign("center");
    obj.label4:setName("label4");

    obj.horzLine4 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine4:setParent(obj.flowPart7);
    obj.horzLine4:setAlign("bottom");
    obj.horzLine4:setStrokeSize(1);
    obj.horzLine4:setStrokeColor("silver");
    obj.horzLine4:setName("horzLine4");

    obj.flowPart8 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart8:setParent(obj.rectangle5);
    obj.flowPart8:setWidth(16);
    obj.flowPart8:setHeight(20);
    obj.flowPart8:setLeft(375);
    obj.flowPart8:setTop(10);
    obj.flowPart8:setName("flowPart8");

    obj.button4 = GUI.fromHandle(_obj_newObject("button"));
    obj.button4:setParent(obj.flowPart8);
    ...
    obj.rclHabilidadesnivel3:setParent(obj.flowLayout7);
    ...
    obj.flowLayout9:setParent(obj.habilidadesLayout);
    ...
    obj.flowPart9:setParent(obj.flowLayout10);
    obj.flowPart9:setHeight(20);
    obj.flowPart9:setWidth(75);
    obj.flowPart9:setVertAlign("center");
    obj.flowPart9:setAlign("client");
    obj.flowPart9:setMargins({top=10});
    obj.flowPart9:setName("flowPart9");

    obj.label5 = GUI.fromHandle(_obj_newObject("label"));
    obj.label5:setParent(obj.flowPart9);
    obj.label5:setText("Nível 4");
    obj.label5:setFontSize(18);
    lfm_setPropAsString(obj.label5, "fontStyle",  "italic bold");
    obj.label5:setAlign("client");
    obj.label5:setHorzTextAlign("center");
    obj.label5:setName("label5");

    obj.horzLine5 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine5:setParent(obj.flowPart9);
    obj.horzLine5:setAlign("bottom");
    obj.horzLine5:setStrokeSize(1);
    obj.horzLine5:setStrokeColor("silver");
    obj.horzLine5:setName("horzLine5");

    obj.flowPart10 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart10:setParent(obj.rectangle6);
    obj.flowPart10:setWidth(16);
    obj.flowPart10:setHeight(20);
    obj.flowPart10:setLeft(375);
    obj.flowPart10:setTop(10);
    obj.flowPart10:setName("flowPart10");

    obj.button5 = GUI.fromHandle(_obj_newObject("button"));
    obj.button5:setParent(obj.flowPart10);
    ...
    obj.rclHabilidadesnivel4:setParent(obj.flowLayout9);
    ...
    obj.flowLayout11:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout12:setParent(obj.rectangle7);
    obj.flowLayout12:setWidth(400);
    obj.flowLayout12:setHeight(40);
    ...
    obj.flowPart11:setParent(obj.flowLayout12);
    obj.flowPart11:setHeight(20);
    obj.flowPart11:setWidth(75);
    obj.flowPart11:setVertAlign("center");
    obj.flowPart11:setAlign("client");
    obj.flowPart11:setMargins({top=10});
    obj.flowPart11:setName("flowPart11");

    obj.label6 = GUI.fromHandle(_obj_newObject("label"));
    obj.label6:setParent(obj.flowPart11);
    obj.label6:setText("Nível 5");
    obj.label6:setFontSize(18);
    lfm_setPropAsString(obj.label6, "fontStyle",  "italic bold");
    obj.label6:setAlign("client");
    obj.label6:setHorzTextAlign("center");
    obj.label6:setName("label6");

    obj.horzLine6 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine6:setParent(obj.flowPart11);
    obj.horzLine6:setAlign("bottom");
    obj.horzLine6:setStrokeSize(1);
    obj.horzLine6:setStrokeColor("silver");
    obj.horzLine6:setName("horzLine6");

    obj.flowPart12 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart12:setParent(obj.rectangle7);
    obj.flowPart12:setWidth(16);
    obj.flowPart12:setHeight(20);
    obj.flowPart12:setLeft(375);
    obj.flowPart12:setTop(10);
    obj.flowPart12:setName("flowPart12");

    obj.button6 = GUI.fromHandle(_obj_newObject("button"));
    obj.button6:setParent(obj.flowPart12);
    ...
    obj.rclHabilidadesnivel5:setParent(obj.flowLayout11);
    ...
    obj.flowLayout13:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout13:setMaxWidth(406);
    obj.flowLayout13:setName("flowLayout13");

    obj.rectangle8 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle8:setParent(obj.flowLayout13);
    ...
    obj.flowLayout14:setParent(obj.rectangle8);
    obj.flowLayout14:setWidth(400);
    obj.flowLayout14:setHeight(40);
    ...
    obj.flowPart13:setParent(obj.flowLayout14);
    obj.flowPart13:setHeight(20);
    obj.flowPart13:setWidth(75);
    obj.flowPart13:setVertAlign("center");
    obj.flowPart13:setAlign("client");
    obj.flowPart13:setMargins({top=10});
    obj.flowPart13:setName("flowPart13");

    obj.label7 = GUI.fromHandle(_obj_newObject("label"));
    obj.label7:setParent(obj.flowPart13);
    obj.label7:setText("Nível 6");
    obj.label7:setFontSize(18);
    lfm_setPropAsString(obj.label7, "fontStyle",  "italic bold");
    obj.label7:setAlign("client");
    obj.label7:setHorzTextAlign("center");
    obj.label7:setName("label7");

    obj.horzLine7 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine7:setParent(obj.flowPart13);
    obj.horzLine7:setAlign("bottom");
    obj.horzLine7:setStrokeSize(1);
    obj.horzLine7:setStrokeColor("silver");
    obj.horzLine7:setName("horzLine7");

    obj.flowPart14 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart14:setParent(obj.rectangle8);
    obj.flowPart14:setWidth(16);
    obj.flowPart14:setHeight(20);
    obj.flowPart14:setLeft(375);
    obj.flowPart14:setTop(10);
    obj.flowPart14:setName("flowPart14");

    obj.button7 = GUI.fromHandle(_obj_newObject("button"));
    obj.button7:setParent(obj.flowPart14);
    ...
    obj.rclHabilidadesnivel6:setParent(obj.flowLayout13);
    ...
    obj.flowLayout15:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout15:setMaxWidth(406);
    obj.flowLayout15:setName("flowLayout15");

    obj.rectangle9 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle9:setParent(obj.flowLayout15);
    ...
    obj.flowLayout16:setWidth(400);
    obj.flowLayout16:setHeight(40);
    ...
    obj.flowPart15:setParent(obj.flowLayout16);
    obj.flowPart15:setHeight(20);
    obj.flowPart15:setWidth(75);
    obj.flowPart15:setVertAlign("center");
    obj.flowPart15:setAlign("client");
    obj.flowPart15:setMargins({top=10});
    obj.flowPart15:setName("flowPart15");

    obj.label8 = GUI.fromHandle(_obj_newObject("label"));
    obj.label8:setParent(obj.flowPart15);
    obj.label8:setText("Nível 7");
    obj.label8:setFontSize(18);
    lfm_setPropAsString(obj.label8, "fontStyle",  "italic bold");
    obj.label8:setAlign("client");
    obj.label8:setHorzTextAlign("center");
    obj.label8:setName("label8");

    obj.horzLine8 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine8:setParent(obj.flowPart15);
    obj.horzLine8:setAlign("bottom");
    obj.horzLine8:setStrokeSize(1);
    obj.horzLine8:setStrokeColor("silver");
    obj.horzLine8:setName("horzLine8");

    obj.flowPart16 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart16:setParent(obj.rectangle9);
    obj.flowPart16:setWidth(16);
    obj.flowPart16:setHeight(20);
    obj.flowPart16:setLeft(375);
    obj.flowPart16:setTop(10);
    obj.flowPart16:setName("flowPart16");

    obj.button8 = GUI.fromHandle(_obj_newObject("button"));
    obj.button8:setParent(obj.flowPart16);
    ...
    obj.rclHabilidadesnivel7:setParent(obj.flowLayout15);
    ...
    obj.flowLayout17:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout17:setMaxWidth(406);
    obj.flowLayout17:setName("flowLayout17");

    obj.rectangle10 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle10:setParent(obj.flowLayout17);
    ...
    obj.flowLayout18:setWidth(400);
    obj.flowLayout18:setHeight(40);
    ...
    obj.flowPart17:setParent(obj.flowLayout18);
    obj.flowPart17:setHeight(20);
    obj.flowPart17:setWidth(75);
    obj.flowPart17:setVertAlign("center");
    obj.flowPart17:setAlign("client");
    obj.flowPart17:setMargins({top=10});
    obj.flowPart17:setName("flowPart17");

    obj.label9 = GUI.fromHandle(_obj_newObject("label"));
    obj.label9:setParent(obj.flowPart17);
    obj.label9:setText("Nível 8");
    obj.label9:setFontSize(18);
    lfm_setPropAsString(obj.label9, "fontStyle",  "italic bold");
    obj.label9:setAlign("client");
    obj.label9:setHorzTextAlign("center");
    obj.label9:setName("label9");

    obj.horzLine9 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine9:setParent(obj.flowPart17);
    obj.horzLine9:setAlign("bottom");
    obj.horzLine9:setStrokeSize(1);
    obj.horzLine9:setStrokeColor("silver");
    obj.horzLine9:setName("horzLine9");

    obj.flowPart18 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart18:setParent(obj.rectangle10);
    obj.flowPart18:setWidth(16);
    obj.flowPart18:setHeight(20);
    obj.flowPart18:setLeft(375);
    obj.flowPart18:setTop(10);
    obj.flowPart18:setName("flowPart18");

    obj.button9 = GUI.fromHandle(_obj_newObject("button"));
    obj.button9:setParent(obj.flowPart18);
    ...
    obj.rclHabilidadesnivel8:setParent(obj.flowLayout17);
    ...
    obj.flowLayout19:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout19:setMaxWidth(406);
    obj.flowLayout19:setName("flowLayout19");

    obj.rectangle11 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle11:setParent(obj.flowLayout19);
    ...
    obj.flowLayout20:setParent(obj.rectangle11);
    obj.flowLayout20:setWidth(400);
    obj.flowLayout20:setHeight(40);
    ...
    obj.flowPart19:setWidth(75);
    obj.flowPart19:setVertAlign("center");
    obj.flowPart19:setAlign("client");
    obj.flowPart19:setMargins({top=10});
    obj.flowPart19:setName("flowPart19");

    obj.label10 = GUI.fromHandle(_obj_newObject("label"));
    obj.label10:setParent(obj.flowPart19);
    obj.label10:setText("Nível 9");
    obj.label10:setFontSize(18);
    lfm_setPropAsString(obj.label10, "fontStyle",  "italic bold");
    obj.label10:setAlign("client");
    obj.label10:setHorzTextAlign("center");
    obj.label10:setName("label10");

    obj.horzLine10 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine10:setParent(obj.flowPart19);
    obj.horzLine10:setAlign("bottom");
    obj.horzLine10:setStrokeSize(1);
    obj.horzLine10:setStrokeColor("silver");
    obj.horzLine10:setName("horzLine10");

    obj.flowPart20 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart20:setParent(obj.rectangle11);
    obj.flowPart20:setWidth(16);
    obj.flowPart20:setHeight(20);
    obj.flowPart20:setLeft(375);
    obj.flowPart20:setTop(10);
    obj.flowPart20:setName("flowPart20");

    obj.button10 = GUI.fromHandle(_obj_newObject("button"));
    obj.button10:setParent(obj.flowPart20);
    ...
    obj.rclHabilidadesnivel9:setParent(obj.flowLayout19);
    ...
    obj.flowLayout21:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout21:setMaxWidth(406);
    obj.flowLayout21:setName("flowLayout21");

    obj.rectangle12 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle12:setParent(obj.flowLayout21);
    ...
    obj.flowLayout22:setParent(obj.rectangle12);
    obj.flowLayout22:setWidth(400);
    obj.flowLayout22:setHeight(40);
    ...
    obj.flowPart21:setParent(obj.flowLayout22);
    obj.flowPart21:setHeight(20);
    obj.flowPart21:setWidth(75);
    obj.flowPart21:setVertAlign("center");
    obj.flowPart21:setAlign("client");
    obj.flowPart21:setMargins({top=10});
    obj.flowPart21:setName("flowPart21");

    obj.label11 = GUI.fromHandle(_obj_newObject("label"));
    obj.label11:setParent(obj.flowPart21);
    obj.label11:setText("Nível 10");
    obj.label11:setFontSize(18);
    lfm_setPropAsString(obj.label11, "fontStyle",  "italic bold");
    obj.label11:setAlign("client");
    obj.label11:setHorzTextAlign("center");
    obj.label11:setName("label11");

    obj.horzLine11 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine11:setParent(obj.flowPart21);
    obj.horzLine11:setAlign("bottom");
    obj.horzLine11:setStrokeSize(1);
    obj.horzLine11:setStrokeColor("silver");
    obj.horzLine11:setName("horzLine11");

    obj.flowPart22 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart22:setParent(obj.rectangle12);
    obj.flowPart22:setWidth(16);
    obj.flowPart22:setHeight(20);
    obj.flowPart22:setLeft(375);
    obj.flowPart22:setTop(10);
    obj.flowPart22:setName("flowPart22");

    obj.button11 = GUI.fromHandle(_obj_newObject("button"));
    obj.button11:setParent(obj.flowPart22);
    ...
    obj.rclHabilidadesnivel10:setParent(obj.flowLayout21);
    ...
    obj.flowLayout23:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout23:setMaxWidth(406);
    obj.flowLayout23:setName("flowLayout23");

    obj.rectangle13 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle13:setParent(obj.flowLayout23);
    ...
    obj.flowLayout24:setWidth(400);
    obj.flowLayout24:setHeight(40);
    ...
    obj.rclHabilidadesnivel11:setParent(obj.flowLayout23);
    ...
    obj.flowLayout25:setParent(obj.habilidadesLayout);
    ...
    obj.flowLayout25:setMaxWidth(406);
    obj.flowLayout25:setName("flowLayout25");

    obj.rectangle14 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle14:setParent(obj.flowLayout25);
    ...
    obj.flowLayout26:setWidth(400);
    obj.flowLayout26:setHeight(40);
    ...
    obj.flowPart25:setParent(obj.flowLayout26);
    obj.flowPart25:setHeight(20);
    obj.flowPart25:setWidth(60);
    obj.flowPart25:setVertAlign("center");
    obj.flowPart25:setAlign("client");
    obj.flowPart25:setMargins({top=10});
    obj.flowPart25:setName("flowPart25");

    obj.label13 = GUI.fromHandle(_obj_newObject("label"));
    obj.label13:setParent(obj.flowPart25);
    obj.label13:setText("Extras");
    obj.label13:setFontSize(18);
    lfm_setPropAsString(obj.label13, "fontStyle",  "italic bold");
    obj.label13:setAlign("client");
    obj.label13:setHorzTextAlign("center");
    obj.label13:setName("label13");

    obj.horzLine13 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine13:setParent(obj.flowPart25);
    obj.horzLine13:setAlign("bottom");
    obj.horzLine13:setStrokeSize(1);
    obj.horzLine13:setStrokeColor("silver");
    obj.horzLine13:setName("horzLine13");

    obj.flowPart26 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart26:setParent(obj.rectangle14);
    obj.flowPart26:setWidth(16);
    obj.flowPart26:setHeight(20);
    obj.flowPart26:setLeft(375);
    obj.flowPart26:setTop(10);
    obj.flowPart26:setName("flowPart26");

    obj.button13 = GUI.fromHandle(_obj_newObject("button"));
    obj.button13:setParent(obj.flowPart26);
    ...
    obj.rclHabilidadesextras:setParent(obj.flowLayout25);
    ...
    obj.editaHabilidade:setParent(obj.rectangle1);
    ...
    obj.flowLayout27:setParent(obj.editaHabilidade);
    obj.flowLayout27:setAlign("client");
    obj.flowLayout27:setMaxControlsPerLine(1);
    obj.flowLayout27:setMargins({left=10,right=10,top=10,bottom=10});
    obj.flowLayout27:setName("flowLayout27");

    obj.rectangle15 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle15:setParent(obj.flowLayout27);
    ...
    obj.flowLayout28:setParent(obj.rectangle15);
    obj.flowLayout28:setHeight(300);
    obj.flowLayout28:setWidth(732);
    obj.flowLayout28:setPadding({left=10,right=10,top=10,bottom=10});
    obj.flowLayout28:setAlign("client");
    obj.flowLayout28:setName("flowLayout28");

    obj.richEdit1 = GUI.fromHandle(_obj_newObject("richEdit"));
    obj.richEdit1:setParent(obj.flowLayout28);
    ...
    obj.flowPart27:setParent(obj.flowLayout27);
    obj.flowPart27:setWidth(135);
    obj.flowPart27:setHeight(20);
    obj.flowPart27:setName("flowPart27");

    obj.label14 = GUI.fromHandle(_obj_newObject("label"));
    obj.label14:setParent(obj.flowPart27);
    obj.label14:setText("Máximo de Cargas:");
    ...
    obj.edit1:setParent(obj.flowPart27);
    ...
    obj.rectangle17:setParent(obj.imagemDoPersonagem);
    ...
    obj.rectangle17:setHeight(250);
    obj.rectangle17:setWidth(250);
    obj.rectangle17:setName("rectangle17");

    obj.image1 = GUI.fromHandle(_obj_newObject("image"));
    obj.image1:setParent(obj.rectangle17);
    obj.image1:setSRC("");
    ...
    obj.flowPart29:setParent(obj.dadosNomeNivel);
    obj.flowPart29:setHeight(50);
    obj.flowPart29:setMinScaledWidth(100);
    obj.flowPart29:setMinWidth(100);
    obj.flowPart29:setMaxWidth(233);
    obj.flowPart29:setMaxScaledWidth(233);
    obj.flowPart29:setAvoidScale(true);
    obj.flowPart29:setName("flowPart29");

    obj.edit3 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit3:setParent(obj.flowPart29);
    ...
    obj.flowPart30:setParent(obj.dadosNomeNivel);
    obj.flowPart30:setHeight(50);
    obj.flowPart30:setMinScaledWidth(100);
    obj.flowPart30:setMinWidth(100);
    obj.flowPart30:setMaxWidth(400);
    obj.flowPart30:setMaxScaledWidth(400);
    obj.flowPart30:setAvoidScale(true);
    obj.flowPart30:setName("flowPart30");

    obj.edit4 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit4:setParent(obj.flowPart30);
    ...
    obj.rectangle18:setParent(obj.dadosDeNivel);
    obj.rectangle18:setCornerType("bevel");
    obj.rectangle18:setAlign("client");
    obj.rectangle18:setYradius(100);
    obj.rectangle18:setXradius(20);
    obj.rectangle18:setStrokeColor("silver");
    obj.rectangle18:setStrokeSize(2);
    obj.rectangle18:setHeight(75);
    obj.rectangle18:setWidth(100);
    obj.rectangle18:setColor("black");
    obj.rectangle18:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle18:setName("rectangle18");

    obj.label19 = GUI.fromHandle(_obj_newObject("label"));
    obj.label19:setParent(obj.rectangle18);
    obj.label19:setAlign("client");
    obj.label19:setField("nivelClasse");
    obj.label19:setHorzTextAlign("center");
    obj.label19:setVertTextAlign("center");
    obj.label19:setFontSize(25);
    lfm_setPropAsString(obj.label19, "fontStyle",  "bold");
    obj.label19:setWidth(60);
    obj.label19:setHeight(20);
    obj.label19:setMargins({top=10});
    obj.label19:setName("label19");

    obj.label20 = GUI.fromHandle(_obj_newObject("label"));
    obj.label20:setParent(obj.rectangle18);
    ...
    obj.rectangle19:setParent(obj.dadosDeNivel);
    obj.rectangle19:setCornerType("bevel");
    obj.rectangle19:setAlign("client");
    obj.rectangle19:setYradius(100);
    obj.rectangle19:setXradius(20);
    obj.rectangle19:setStrokeColor("silver");
    obj.rectangle19:setStrokeSize(2);
    obj.rectangle19:setHeight(75);
    obj.rectangle19:setWidth(100);
    obj.rectangle19:setColor("black");
    obj.rectangle19:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle19:setName("rectangle19");

    obj.label21 = GUI.fromHandle(_obj_newObject("label"));
    obj.label21:setParent(obj.rectangle19);
    obj.label21:setAlign("client");
    obj.label21:setField("nivelProfissao");
    ...
    obj.label21:setMargins({top=10});
    obj.label21:setName("label21");

    obj.label22 = GUI.fromHandle(_obj_newObject("label"));
    obj.label22:setParent(obj.rectangle19);
    obj.label22:setText("Profissão");
    ...
    obj.button15:setParent(obj.dadosDeNivel);
    ...
    obj.rectangle20:setParent(obj.dadosDeNivel);
    obj.rectangle20:setCornerType("bevel");
    obj.rectangle20:setAlign("client");
    obj.rectangle20:setYradius(100);
    obj.rectangle20:setXradius(20);
    obj.rectangle20:setStrokeColor("silver");
    obj.rectangle20:setStrokeSize(2);
    obj.rectangle20:setHeight(75);
    obj.rectangle20:setWidth(100);
    obj.rectangle20:setColor("black");
    obj.rectangle20:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle20:setName("rectangle20");

    obj.label23 = GUI.fromHandle(_obj_newObject("label"));
    obj.label23:setParent(obj.rectangle20);
    obj.label23:setAlign("client");
    obj.label23:setField("pDestino");
    obj.label23:setHorzTextAlign("center");
    obj.label23:setVertTextAlign("center");
    obj.label23:setFontSize(25);
    lfm_setPropAsString(obj.label23, "fontStyle",  "bold");
    obj.label23:setWidth(60);
    obj.label23:setHeight(20);
    obj.label23:setMargins({top=10});
    obj.label23:setName("label23");

    obj.label24 = GUI.fromHandle(_obj_newObject("label"));
    obj.label24:setParent(obj.rectangle20);
    obj.label24:setText("P.Destino");
    ...
    obj.button16:setParent(obj.dadosDeNivel);
    ...
    obj.flowPart31:setParent(obj.dadosGerais);
    obj.flowPart31:setHeight(50);
    obj.flowPart31:setMinScaledWidth(100);
    obj.flowPart31:setMinWidth(100);
    obj.flowPart31:setMaxWidth(233);
    obj.flowPart31:setMaxScaledWidth(233);
    obj.flowPart31:setAvoidScale(true);
    obj.flowPart31:setName("flowPart31");

    obj.edit5 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit5:setParent(obj.flowPart31);
    ...
    obj.flowPart32:setParent(obj.dadosGerais);
    obj.flowPart32:setHeight(50);
    obj.flowPart32:setMinScaledWidth(100);
    obj.flowPart32:setMinWidth(100);
    obj.flowPart32:setMaxWidth(233);
    obj.flowPart32:setMaxScaledWidth(233);
    obj.flowPart32:setAvoidScale(true);
    obj.flowPart32:setName("flowPart32");

    obj.edit6 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit6:setParent(obj.flowPart32);
    ...
    obj.flowPart33:setParent(obj.dadosGerais);
    obj.flowPart33:setHeight(50);
    obj.flowPart33:setMinScaledWidth(100);
    obj.flowPart33:setMinWidth(100);
    obj.flowPart33:setMaxWidth(233);
    obj.flowPart33:setMaxScaledWidth(233);
    obj.flowPart33:setAvoidScale(true);
    obj.flowPart33:setName("flowPart33");

    obj.edit7 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit7:setParent(obj.flowPart33);
    ...
    obj.flowPart34:setParent(obj.dadosGerais);
    obj.flowPart34:setHeight(50);
    obj.flowPart34:setMinScaledWidth(100);
    obj.flowPart34:setMinWidth(100);
    obj.flowPart34:setMaxWidth(233);
    obj.flowPart34:setMaxScaledWidth(233);
    obj.flowPart34:setAvoidScale(true);
    obj.flowPart34:setName("flowPart34");

    obj.edit8 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit8:setParent(obj.flowPart34);
    ...
    obj.flowPart35:setParent(obj.dadosGerais);
    obj.flowPart35:setHeight(50);
    obj.flowPart35:setMinScaledWidth(100);
    obj.flowPart35:setMinWidth(100);
    obj.flowPart35:setMaxWidth(233);
    obj.flowPart35:setMaxScaledWidth(233);
    obj.flowPart35:setAvoidScale(true);
    obj.flowPart35:setName("flowPart35");

    obj.edit9 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit9:setParent(obj.flowPart35);
    obj.edit9:setAlign("top");
    obj.edit9:setField("nacionalidade");
    ...
    obj.flowPart36:setParent(obj.dadosGerais);
    obj.flowPart36:setHeight(50);
    obj.flowPart36:setMinScaledWidth(100);
    obj.flowPart36:setMinWidth(100);
    obj.flowPart36:setMaxWidth(233);
    obj.flowPart36:setMaxScaledWidth(233);
    ...
    obj.horzLine24:setParent(obj.flowPart36);
    obj.horzLine24:setAlign("top");
    obj.horzLine24:setStrokeColor("#FFFFFF50");
    obj.horzLine24:setStrokeSize(1);
    obj.horzLine24:setMargins({right=5});
    obj.horzLine24:setName("horzLine24");

    obj.label30 = GUI.fromHandle(_obj_newObject("label"));
    obj.label30:setParent(obj.flowPart36);
    obj.label30:setAlign("top");
    obj.label30:setText("Divindade");
    obj.label30:setVertTextAlign("leading");
    ...
    obj.rectangle21:setParent(obj.vidaEDefesa);
    ...
    obj.rectangle21:setWidth(100);
    obj.rectangle21:setColor("black");
    obj.rectangle21:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle21:setName("rectangle21");

    obj.label31 = GUI.fromHandle(_obj_newObject("label"));
    obj.label31:setParent(obj.rectangle21);
    obj.label31:setAlign("client");
    obj.label31:setHorzTextAlign("leading");
    obj.label31:setText("Vida:");
    obj.label31:setMargins({left=5, top=5});
    obj.label31:setVertTextAlign("center");
    obj.label31:setFontSize(16);
    lfm_setPropAsString(obj.label31, "fontStyle",  "italic bold");
    obj.label31:setWidth(60);
    obj.label31:setHeight(20);
    obj.label31:setName("label31");

    obj.label32 = GUI.fromHandle(_obj_newObject("label"));
    obj.label32:setParent(obj.rectangle21);
    obj.label32:setAlign("client");
    obj.label32:setField("atributoVida");
    obj.label32:setHorzTextAlign("trailing");
    obj.label32:setMargins({right=8, top=5});
    obj.label32:setVertTextAlign("center");
    obj.label32:setFontSize(17);
    ...
    obj.rectangle22:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle22:setName("rectangle22");

    obj.label33 = GUI.fromHandle(_obj_newObject("label"));
    obj.label33:setParent(obj.rectangle22);
    obj.label33:setAlign("client");
    obj.label33:setHorzTextAlign("leading");
    obj.label33:setText("Defesa:");
    obj.label33:setMargins({left=5, top=5});
    obj.label33:setVertTextAlign("center");
    obj.label33:setFontSize(16);
    lfm_setPropAsString(obj.label33, "fontStyle",  "italic bold");
    obj.label33:setWidth(60);
    obj.label33:setHeight(20);
    obj.label33:setName("label33");

    obj.label34 = GUI.fromHandle(_obj_newObject("label"));
    obj.label34:setParent(obj.rectangle22);
    obj.label34:setAlign("client");
    obj.label34:setField("atributoDefesa");
    obj.label34:setHorzTextAlign("trailing");
    obj.label34:setMargins({right=8, top=5});
    obj.label34:setVertTextAlign("center");
    obj.label34:setFontSize(17);
    ...
    obj.rectangle23:setParent(obj.atributosDestreza);
    ...
    obj.rectangle23:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle23:setName("rectangle23");

    obj.edit11 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit11:setParent(obj.rectangle23);
    obj.edit11:setAlign("top");
    obj.edit11:setField("atributoAcerto");
    ...
    obj.label35:setParent(obj.rectangle23);
    obj.label35:setAlign("client");
    obj.label35:setField("modAcerto");
    ...
    obj.label35:setMargins({bottom=8});
    ...
    obj.rectangle24:setParent(obj.atributosDestreza);
    ...
    obj.rectangle24:setHeight(100);
    obj.rectangle24:setWidth(100);
    obj.rectangle24:setColor("black");
    obj.rectangle24:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle24:setName("rectangle24");

    obj.edit12 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit12:setParent(obj.rectangle24);
    obj.edit12:setAlign("top");
    obj.edit12:setField("atributoMira");
    ...
    obj.label37:setMargins({bottom=8});
    obj.label37:setName("label37");

    obj.label38 = GUI.fromHandle(_obj_newObject("label"));
    obj.label38:setParent(obj.rectangle24);
    obj.label38:setText("Mira");
    ...
    obj.rectangle25:setParent(obj.atributosDestreza);
    ...
    obj.rectangle25:setMargins({left=2.5});
    obj.rectangle25:setName("rectangle25");

    obj.label39 = GUI.fromHandle(_obj_newObject("label"));
    obj.label39:setParent(obj.rectangle25);
    obj.label39:setField("destrezaDisponivel");
    ...
    obj.rectangle26:setParent(obj.atributosDestreza);
    ...
    obj.rectangle26:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle26:setName("rectangle26");

    obj.edit13 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit13:setParent(obj.rectangle26);
    obj.edit13:setAlign("top");
    obj.edit13:setField("atributoEsquiva");
    ...
    obj.label40:setParent(obj.rectangle26);
    obj.label40:setAlign("client");
    obj.label40:setField("modEsquiva");
    ...
    obj.label40:setMargins({bottom=8});
    obj.label40:setName("label40");

    obj.label41 = GUI.fromHandle(_obj_newObject("label"));
    obj.label41:setParent(obj.rectangle26);
    obj.label41:setText("Esquiva");
    ...
    obj.rectangle27:setParent(obj.atributosDestreza);
    ...
    obj.rectangle27:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle27:setName("rectangle27");

    obj.edit14 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit14:setParent(obj.rectangle27);
    obj.edit14:setAlign("top");
    obj.edit14:setField("atributoBloqueio");
    ...
    obj.label42:setParent(obj.rectangle27);
    obj.label42:setAlign("client");
    obj.label42:setField("modBloqueio");
    obj.label42:setHorzTextAlign("center");
    obj.label42:setVertTextAlign("center");
    obj.label42:setFontSize(30);
    lfm_setPropAsString(obj.label42, "fontStyle",  "bold");
    obj.label42:setWidth(60);
    obj.label42:setHeight(20);
    obj.label42:setMargins({bottom=8});
    obj.label42:setName("label42");

    obj.label43 = GUI.fromHandle(_obj_newObject("label"));
    obj.label43:setParent(obj.rectangle27);
    obj.label43:setText("Bloqueio");
    ...
    obj.label44:setParent(obj.dadosAdicionais);
    obj.label44:setWidth(300);
    obj.label44:setHeight(5);
    obj.label44:setFontSize(12);
    obj.label44:setText("Experiência de Classe:");
    obj.label44:setHorzTextAlign("center");
    obj.label44:setVertTextAlign("leading");
    obj.label44:setMargins({top=5,bottom=5});
    ...
    obj.label45:setParent(obj.dadosAdicionais);
    obj.label45:setWidth(250);
    obj.label45:setHeight(5);
    obj.label45:setFontSize(12);
    obj.label45:setHorzTextAlign("trailing");
    obj.label45:setVertTextAlign("trailing");
    obj.label45:setMargins({top=5,bottom=5});
    obj.label45:setField("xpTextoClasse");
    ...
    obj.flowLayout29:setParent(obj.popupxpClasse);
    obj.flowLayout29:setWidth(250);
    obj.flowLayout29:setHeight(30);
    obj.flowLayout29:setMaxControlsPerLine(3);
    obj.flowLayout29:setName("flowLayout29");

    obj.label46 = GUI.fromHandle(_obj_newObject("label"));
    obj.label46:setParent(obj.flowLayout29);
    obj.label46:setText("Adicionar Experiência: ");
    ...
    obj.label47:setParent(obj.dadosAdicionais);
    obj.label47:setWidth(300);
    obj.label47:setHeight(5);
    obj.label47:setFontSize(12);
    obj.label47:setText("Experiência de Profissão:");
    obj.label47:setHorzTextAlign("center");
    obj.label47:setVertTextAlign("leading");
    obj.label47:setMargins({top=5,bottom=5});
    ...
    obj.label48:setParent(obj.dadosAdicionais);
    obj.label48:setWidth(250);
    obj.label48:setHeight(5);
    obj.label48:setFontSize(12);
    obj.label48:setHorzTextAlign("trailing");
    obj.label48:setVertTextAlign("trailing");
    obj.label48:setMargins({top=5,bottom=5});
    obj.label48:setField("xpTextoProfissao");
    ...
    obj.flowLayout30:setParent(obj.popupxpProfissao);
    obj.flowLayout30:setWidth(250);
    obj.flowLayout30:setHeight(30);
    obj.flowLayout30:setMaxControlsPerLine(3);
    obj.flowLayout30:setName("flowLayout30");

    obj.label49 = GUI.fromHandle(_obj_newObject("label"));
    obj.label49:setParent(obj.flowLayout30);
    obj.label49:setText("Adicionar Experiência: ");
    ...
    obj.dataLink5:setFields({'xpMaxClasse', 'xpAtualClasse', 'xpTextoClasse', 'nivelClasse', 'atributoVida', 'conTotal', 'atributoDefesa'});
    ...
    obj.flowPart39:setParent(obj.perfilLayout);
    obj.flowPart39:setHeight(2);
    obj.flowPart39:setMinScaledWidth(100);
    obj.flowPart39:setMaxScaledWidth(1600);
    obj.flowPart39:setName("flowPart39");

    obj.horzLine29 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine29:setParent(obj.flowPart39);
    obj.horzLine29:setStrokeColor("#FFFFFF50");
    obj.horzLine29:setStrokeSize(0.6);
    obj.horzLine29:setStrokeCap("round");
    obj.horzLine29:setScaleY(0.1);
    obj.horzLine29:setTop(1);
    ...
    obj.flowPart40:setParent(obj.perfilLayout);
    obj.flowPart40:setWidth(140);
    ...
    obj.flowPart41:setParent(obj.topoAtributos);
    obj.flowPart41:setHeight(20);
    obj.flowPart41:setMinScaledWidth(60);
    obj.flowPart41:setMaxScaledWidth(85);
    obj.flowPart41:setName("flowPart41");

    obj.label50 = GUI.fromHandle(_obj_newObject("label"));
    obj.label50:setParent(obj.flowPart41);
    obj.label50:setText("Nível");
    obj.label50:setAlign("client");
    obj.label50:setField("");
    obj.label50:setFontSize(8);
    ...
    obj.flowPart42:setParent(obj.topoAtributos);
    obj.flowPart42:setHeight(20);
    obj.flowPart42:setMinScaledWidth(60);
    obj.flowPart42:setMaxScaledWidth(85);
    obj.flowPart42:setName("flowPart42");

    obj.label51 = GUI.fromHandle(_obj_newObject("label"));
    obj.label51:setParent(obj.flowPart42);
    obj.label51:setText("Classe");
    obj.label51:setAlign("client");
    obj.label51:setField("");
    obj.label51:setFontSize(8);
    ...
    obj.flowPart43:setParent(obj.topoAtributos);
    ...
    obj.label52:setParent(obj.flowPart43);
    obj.label52:setText("Raça");
    obj.label52:setAlign("client");
    obj.label52:setField("");
    obj.label52:setFontSize(8);
    ...
    obj.flowPart44:setParent(obj.topoAtributos);
    obj.flowPart44:setHeight(20);
    obj.flowPart44:setMinScaledWidth(60);
    obj.flowPart44:setMaxScaledWidth(85);
    obj.flowPart44:setName("flowPart44");

    obj.label53 = GUI.fromHandle(_obj_newObject("label"));
    obj.label53:setParent(obj.flowPart44);
    obj.label53:setText("Treino");
    obj.label53:setAlign("client");
    obj.label53:setField("");
    obj.label53:setFontSize(8);
    ...
    obj.flowPart45:setParent(obj.topoAtributos);
    obj.flowPart45:setHeight(20);
    obj.flowPart45:setMinScaledWidth(60);
    obj.flowPart45:setMaxScaledWidth(85);
    ...
    obj.label54:setField("");
    obj.label54:setFontSize(8);
    ...
    obj.flowPart46:setParent(obj.topoAtributos);
    obj.flowPart46:setHeight(20);
    obj.flowPart46:setMinScaledWidth(60);
    obj.flowPart46:setMaxScaledWidth(85);
    obj.flowPart46:setName("flowPart46");

    obj.label55 = GUI.fromHandle(_obj_newObject("label"));
    obj.label55:setParent(obj.flowPart46);
    obj.label55:setText("Base");
    obj.label55:setAlign("client");
    obj.label55:setField("");
    obj.label55:setFontSize(8);
    ...
    obj.flowPart47:setParent(obj.topoAtributos);
    obj.flowPart47:setHeight(20);
    obj.flowPart47:setMinScaledWidth(60);
    obj.flowPart47:setMaxScaledWidth(85);
    obj.flowPart47:setName("flowPart47");

    obj.label56 = GUI.fromHandle(_obj_newObject("label"));
    obj.label56:setParent(obj.flowPart47);
    obj.label56:setText("Equip.");
    obj.label56:setAlign("client");
    obj.label56:setField("");
    obj.label56:setFontSize(8);
    ...
    obj.flowPart48:setParent(obj.topoAtributos);
    obj.flowPart48:setHeight(20);
    obj.flowPart48:setMinScaledWidth(60);
    obj.flowPart48:setMaxScaledWidth(85);
    obj.flowPart48:setName("flowPart48");

    obj.label57 = GUI.fromHandle(_obj_newObject("label"));
    obj.label57:setParent(obj.flowPart48);
    obj.label57:setText("Total");
    obj.label57:setAlign("client");
    obj.label57:setField("");
    obj.label57:setFontSize(8);
    ...
    obj.flowPart49:setMinScaledWidth(60);
    obj.flowPart49:setMaxScaledWidth(85);
    obj.flowPart49:setName("flowPart49");

    obj.label58 = GUI.fromHandle(_obj_newObject("label"));
    obj.label58:setParent(obj.flowPart49);
    obj.label58:setText("Constituição");
    obj.label58:setAlign("client");
    obj.label58:setField("");
    obj.label58:setFontSize(8);
    ...
    obj.horzLine30:setParent(obj.flowPart50);
    ...
    obj.image2:setParent(obj.flowPart51);
    ...
    obj.edit16:setParent(obj.flowPart52);
    obj.edit16:setAlign("top");
    obj.edit16:setField("conClasse");
    ...
    obj.horzLine31:setParent(obj.flowPart52);
    ...
    obj.image3:setParent(obj.flowPart53);
    ...
    obj.edit17:setParent(obj.flowPart54);
    obj.edit17:setAlign("top");
    obj.edit17:setField("conRaca");
    ...
    obj.horzLine32:setParent(obj.flowPart54);
    ...
    obj.image4:setParent(obj.flowPart55);
    ...
    obj.edit18:setParent(obj.flowPart56);
    obj.edit18:setAlign("top");
    obj.edit18:setField("conTreino");
    ...
    obj.horzLine33:setParent(obj.flowPart56);
    ...
    obj.image5:setParent(obj.flowPart57);
    ...
    obj.edit19:setParent(obj.flowPart58);
    obj.edit19:setAlign("top");
    obj.edit19:setField("conOutros");
    ...
    obj.horzLine34:setParent(obj.flowPart58);
    ...
    obj.image6:setParent(obj.flowPart59);
    ...
    obj.edit20:setParent(obj.flowPart60);
    obj.edit20:setAlign("top");
    obj.edit20:setField("conBase");
    ...
    obj.horzLine35:setParent(obj.flowPart60);
    ...
    obj.image7:setParent(obj.flowPart61);
    ...
    obj.edit21:setParent(obj.flowPart62);
    obj.edit21:setAlign("top");
    obj.edit21:setField("conEquip");
    ...
    obj.horzLine36:setParent(obj.flowPart62);
    ...
    obj.image8:setParent(obj.flowPart63);
    ...
    obj.edit22:setParent(obj.flowPart64);
    obj.edit22:setAlign("top");
    obj.edit22:setField("conTotal");
    ...
    obj.horzLine37:setParent(obj.flowPart64);
    ...
    obj.flowPart65:setMinScaledWidth(60);
    obj.flowPart65:setMaxScaledWidth(85);
    obj.flowPart65:setName("flowPart65");

    obj.label59 = GUI.fromHandle(_obj_newObject("label"));
    obj.label59:setParent(obj.flowPart65);
    obj.label59:setText("Força");
    obj.label59:setAlign("client");
    obj.label59:setField("");
    obj.label59:setFontSize(8);
    ...
    obj.horzLine38:setParent(obj.flowPart66);
    ...
    obj.image9:setParent(obj.flowPart67);
    ...
    obj.edit24:setParent(obj.flowPart68);
    obj.edit24:setAlign("top");
    obj.edit24:setField("forClasse");
    ...
    obj.horzLine39:setParent(obj.flowPart68);
    ...
    obj.image10:setParent(obj.flowPart69);
    ...
    obj.edit25:setParent(obj.flowPart70);
    obj.edit25:setAlign("top");
    obj.edit25:setField("forRaca");
    ...
    obj.horzLine40:setParent(obj.flowPart70);
    ...
    obj.flowPart71:setHeight(50);
    obj.flowPart71:setMinScaledWidth(30);
    obj.flowPart71:setMaxScaledWidth(50);

    obj.image11 = GUI.fromHandle(_obj_newObject("image"));
    obj.image11:setParent(obj.flowPart71);
    ...
    obj.edit26:setParent(obj.flowPart72);
    obj.edit26:setAlign("top");
    obj.edit26:setField("forTreino");
    ...
    obj.horzLine41:setParent(obj.flowPart72);
    ...
    obj.image12:setParent(obj.flowPart73);
    ...
    obj.edit27:setParent(obj.flowPart74);
    obj.edit27:setAlign("top");
    obj.edit27:setField("forOutros");
    ...
    obj.horzLine42:setParent(obj.flowPart74);
    ...
    obj.image13:setParent(obj.flowPart75);
    ...
    obj.edit28:setParent(obj.flowPart76);
    obj.edit28:setAlign("top");
    obj.edit28:setField("forBase");
    ...
    obj.horzLine43:setParent(obj.flowPart76);
    ...
    obj.image14:setParent(obj.flowPart77);
    ...
    obj.edit29:setParent(obj.flowPart78);
    obj.edit29:setAlign("top");
    obj.edit29:setField("forEquip");
    ...
    obj.horzLine44:setParent(obj.flowPart78);
    ...
    obj.image15:setParent(obj.flowPart79);
    ...
    obj.edit30:setParent(obj.flowPart80);
    obj.edit30:setAlign("top");
    obj.edit30:setField("forTotal");
    ...
    obj.horzLine45:setParent(obj.flowPart80);
    ...
    obj.flowPart81:setMinScaledWidth(60);
    obj.flowPart81:setMaxScaledWidth(85);
    obj.flowPart81:setName("flowPart81");

    obj.label60 = GUI.fromHandle(_obj_newObject("label"));
    obj.label60:setParent(obj.flowPart81);
    obj.label60:setText("Destreza");
    obj.label60:setAlign("client");
    obj.label60:setField("");
    obj.label60:setFontSize(8);
    ...
    obj.edit31:setParent(obj.flowPart82);
    obj.edit31:setAlign("top");
    obj.edit31:setField("dexNivel");
    ...
    obj.horzLine46:setParent(obj.flowPart82);
    ...
    obj.image16:setParent(obj.flowPart83);
    ...
    obj.edit32:setParent(obj.flowPart84);
    obj.edit32:setAlign("top");
    obj.edit32:setField("dexClasse");
    ...
    obj.horzLine47:setParent(obj.flowPart84);
    ...
    obj.image17:setParent(obj.flowPart85);
    ...
    obj.edit33:setParent(obj.flowPart86);
    obj.edit33:setAlign("top");
    obj.edit33:setField("dexRaca");
    ...
    obj.horzLine48:setParent(obj.flowPart86);
    ...
    obj.image18:setParent(obj.flowPart87);
    ...
    obj.edit34:setParent(obj.flowPart88);
    obj.edit34:setAlign("top");
    obj.edit34:setField("dexTreino");
    ...
    obj.horzLine49:setParent(obj.flowPart88);
    ...
    obj.image19:setParent(obj.flowPart89);
    ...
    obj.edit35:setParent(obj.flowPart90);
    obj.edit35:setAlign("top");
    obj.edit35:setField("dexOutros");
    ...
    obj.horzLine50:setParent(obj.flowPart90);
    ...
    obj.image20:setParent(obj.flowPart91);
    ...
    obj.edit36:setParent(obj.flowPart92);
    obj.edit36:setAlign("top");
    obj.edit36:setField("dexBase");
    ...
    obj.horzLine51:setParent(obj.flowPart92);
    ...
    obj.image21:setParent(obj.flowPart93);
    ...
    obj.edit37:setParent(obj.flowPart94);
    obj.edit37:setAlign("top");
    obj.edit37:setField("dexEquip");
    ...
    obj.horzLine52:setParent(obj.flowPart94);
    ...
    obj.image22:setParent(obj.flowPart95);
    ...
    obj.edit38:setParent(obj.flowPart96);
    ...
    obj.horzLine53:setParent(obj.flowPart96);
    ...
    obj.flowPart97:setMinScaledWidth(60);
    obj.flowPart97:setMaxScaledWidth(85);
    obj.flowPart97:setName("flowPart97");

    obj.label61 = GUI.fromHandle(_obj_newObject("label"));
    obj.label61:setParent(obj.flowPart97);
    ...
    obj.edit39:setParent(obj.flowPart98);
    obj.edit39:setAlign("top");
    obj.edit39:setField("carNivel");
    ...
    obj.horzLine54:setParent(obj.flowPart98);
    ...
    obj.image23:setParent(obj.flowPart99);
    ...
    obj.edit40:setParent(obj.flowPart100);
    obj.edit40:setAlign("top");
    obj.edit40:setField("carClasse");
    ...
    obj.horzLine55:setParent(obj.flowPart100);
    ...
    obj.image24:setParent(obj.flowPart101);
    ...
    obj.edit41:setParent(obj.flowPart102);
    obj.edit41:setAlign("top");
    obj.edit41:setField("carRaca");
    ...
    obj.horzLine56:setParent(obj.flowPart102);
    ...
    obj.image25:setParent(obj.flowPart103);
    ...
    obj.edit42:setParent(obj.flowPart104);
    obj.edit42:setAlign("top");
    obj.edit42:setField("carTreino");
    ...
    obj.horzLine57:setParent(obj.flowPart104);
    ...
    obj.image26:setParent(obj.flowPart105);
    ...
    obj.edit43:setParent(obj.flowPart106);
    obj.edit43:setAlign("top");
    obj.edit43:setField("carOutros");
    ...
    obj.horzLine58:setParent(obj.flowPart106);
    ...
    obj.image27:setParent(obj.flowPart107);
    ...
    obj.edit44:setParent(obj.flowPart108);
    obj.edit44:setAlign("top");
    obj.edit44:setField("carBase");
    ...
    obj.horzLine59:setParent(obj.flowPart108);
    ...
    obj.image28:setParent(obj.flowPart109);
    ...
    obj.edit45:setParent(obj.flowPart110);
    obj.edit45:setAlign("top");
    obj.edit45:setField("carEquip");
    ...
    obj.horzLine60:setParent(obj.flowPart110);
    ...
    obj.image29:setParent(obj.flowPart111);
    ...
    obj.edit46:setParent(obj.flowPart112);
    obj.edit46:setAlign("top");
    obj.edit46:setField("carTotal");
    ...
    obj.horzLine61:setParent(obj.flowPart112);
    ...
    obj.flowPart113:setMinScaledWidth(60);
    obj.flowPart113:setMaxScaledWidth(85);
    obj.flowPart113:setName("flowPart113");

    obj.label62 = GUI.fromHandle(_obj_newObject("label"));
    obj.label62:setParent(obj.flowPart113);
    obj.label62:setText("Inteligência");
    obj.label62:setAlign("client");
    obj.label62:setField("");
    obj.label62:setFontSize(8);
    ...
    obj.edit47:setParent(obj.flowPart114);
    obj.edit47:setAlign("top");
    obj.edit47:setField("intNivel");
    ...
    obj.horzLine62:setParent(obj.flowPart114);
    ...
    obj.image30:setParent(obj.flowPart115);
    ...
    obj.edit48:setParent(obj.flowPart116);
    obj.edit48:setAlign("top");
    obj.edit48:setField("intClasse");
    ...
    obj.horzLine63:setParent(obj.flowPart116);
    obj.horzLine63:setAlign("top");
    ...
    obj.image31:setParent(obj.flowPart117);
    ...
    obj.edit49:setParent(obj.flowPart118);
    obj.edit49:setAlign("top");
    obj.edit49:setField("intRaca");
    ...
    obj.horzLine64:setParent(obj.flowPart118);
    obj.horzLine64:setAlign("top");
    ...
    obj.image32:setParent(obj.flowPart119);
    ...
    obj.edit50:setParent(obj.flowPart120);
    obj.edit50:setAlign("top");
    obj.edit50:setField("intTreino");
    ...
    obj.horzLine65:setParent(obj.flowPart120);
    obj.horzLine65:setAlign("top");
    ...
    obj.image33:setParent(obj.flowPart121);
    ...
    obj.edit51:setParent(obj.flowPart122);
    obj.edit51:setAlign("top");
    obj.edit51:setField("intOutros");
    ...
    obj.horzLine66:setParent(obj.flowPart122);
    obj.horzLine66:setAlign("top");
    ...
    obj.image34:setParent(obj.flowPart123);
    ...
    obj.edit52:setParent(obj.flowPart124);
    obj.edit52:setAlign("top");
    obj.edit52:setField("intBase");
    ...
    obj.horzLine67:setParent(obj.flowPart124);
    obj.horzLine67:setAlign("top");
    ...
    obj.image35:setParent(obj.flowPart125);
    ...
    obj.edit53:setParent(obj.flowPart126);
    obj.edit53:setAlign("top");
    obj.edit53:setField("intEquip");
    ...
    obj.horzLine68:setParent(obj.flowPart126);
    obj.horzLine68:setAlign("top");
    ...
    obj.image36:setParent(obj.flowPart127);
    ...
    obj.edit54:setParent(obj.flowPart128);
    obj.edit54:setAlign("top");
    obj.edit54:setField("intTotal");
    ...
    obj.horzLine69:setParent(obj.flowPart128);
    obj.horzLine69:setAlign("top");
    ...
    obj.flowPart129:setMinScaledWidth(60);
    obj.flowPart129:setMaxScaledWidth(85);
    obj.flowPart129:setName("flowPart129");

    obj.label63 = GUI.fromHandle(_obj_newObject("label"));
    obj.label63:setParent(obj.flowPart129);
    obj.label63:setText("Sabedoria");
    obj.label63:setAlign("client");
    obj.label63:setField("");
    obj.label63:setFontSize(8);
    ...
    obj.edit55:setParent(obj.flowPart130);
    obj.edit55:setAlign("top");
    obj.edit55:setField("sabNivel");
    ...
    obj.horzLine70:setParent(obj.flowPart130);
    obj.horzLine70:setAlign("top");
    ...
    obj.image37:setParent(obj.flowPart131);
    ...
    obj.edit56:setParent(obj.flowPart132);
    obj.edit56:setAlign("top");
    obj.edit56:setField("sabClasse");
    ...
    obj.horzLine71:setParent(obj.flowPart132);
    obj.horzLine71:setAlign("top");
    ...
    obj.image38:setParent(obj.flowPart133);
    ...
    obj.edit57:setParent(obj.flowPart134);
    obj.edit57:setAlign("top");
    obj.edit57:setField("sabRaca");
    ...
    obj.horzLine72:setParent(obj.flowPart134);
    obj.horzLine72:setAlign("top");
    ...
    obj.image39:setParent(obj.flowPart135);
    ...
    obj.edit58:setParent(obj.flowPart136);
    obj.edit58:setAlign("top");
    obj.edit58:setField("sabTreino");
    ...
    obj.horzLine73:setParent(obj.flowPart136);
    obj.horzLine73:setAlign("top");
    ...
    obj.image40:setParent(obj.flowPart137);
    ...
    obj.edit59:setParent(obj.flowPart138);
    obj.edit59:setAlign("top");
    obj.edit59:setField("sabOutros");
    ...
    obj.horzLine74:setParent(obj.flowPart138);
    obj.horzLine74:setAlign("top");
    ...
    obj.image41:setParent(obj.flowPart139);
    ...
    obj.edit60:setParent(obj.flowPart140);
    obj.edit60:setAlign("top");
    obj.edit60:setField("sabBase");
    ...
    obj.horzLine75:setParent(obj.flowPart140);
    obj.horzLine75:setAlign("top");
    ...
    obj.image42:setParent(obj.flowPart141);
    ...
    obj.edit61:setParent(obj.flowPart142);
    obj.edit61:setAlign("top");
    obj.edit61:setField("sabEquip");
    ...
    obj.horzLine76:setParent(obj.flowPart142);
    obj.horzLine76:setAlign("top");
    ...
    obj.image43:setParent(obj.flowPart143);
    ...
    obj.edit62:setParent(obj.flowPart144);
    obj.edit62:setAlign("top");
    obj.edit62:setField("sabTotal");
    ...
    obj.horzLine77:setParent(obj.flowPart144);
    obj.horzLine77:setAlign("top");
    ...
    obj.flowPart145:setParent(obj.perfilLayout);
    obj.flowPart145:setHeight(2);
    obj.flowPart145:setMinScaledWidth(100);
    obj.flowPart145:setMaxScaledWidth(1600);
    obj.flowPart145:setName("flowPart145");

    obj.horzLine78 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine78:setParent(obj.flowPart145);
    obj.horzLine78:setStrokeColor("#FFFFFF50");
    obj.horzLine78:setStrokeSize(0.6);
    obj.horzLine78:setStrokeCap("round");
    obj.horzLine78:setScaleY(0.1);
    obj.horzLine78:setTop(1);
    ...
    obj.label64:setParent(obj.topoPtBonusEConhecimentos);
    obj.label64:setText("Pontos Restantes: ");
    ...
    obj.edit63:setField("pontosRestantes");
    ...
    obj.label65:setParent(obj.topoPtBonusEConhecimentos);
    obj.label65:setText("Pontos Treinados: ");
    ...
    obj.edit64:setField("pontosTreinados");
    ...
    obj.label66:setParent(obj.topoPtBonusEConhecimentos);
    obj.label66:setText("Pontos de Conhecimento: ");
    ...
    obj.edit65:setField("pontosDeConhecimento");
    ...
    obj.label67:setParent(obj.topoPtBonusEConhecimentos);
    obj.label67:setText("Pontos Con. Distribuidos: ");
    ...
    obj.edit66:setField("pontosDeConhecimentoDistribuidos");
    ...
    obj.flowPart146:setParent(obj.tabelaPontosBonus);
    ...
    obj.flowLayout31:setParent(obj.tabelaPontosBonus);
    obj.flowLayout31:setHeight(20);
    obj.flowLayout31:setMinWidth(150);
    obj.flowLayout31:setMaxWidth(200);
    ...
    obj.percepcaoMinus:setParent(obj.flowLayout31);
    ...
    obj.edit67:setParent(obj.flowPart147);
    obj.edit67:setAlign("client");
    obj.edit67:setField("percepcao");
    ...
    obj.percepcaoPlus:setParent(obj.flowLayout31);
    ...
    obj.flowPart148:setParent(obj.tabelaPontosBonus);
    ...
    obj.flowLayout32:setParent(obj.tabelaPontosBonus);
    obj.flowLayout32:setHeight(20);
    obj.flowLayout32:setMinWidth(150);
    obj.flowLayout32:setMaxWidth(200);
    ...
    obj.intimidacaoMinus:setParent(obj.flowLayout32);
    ...
    obj.edit68:setParent(obj.flowPart149);
    obj.edit68:setAlign("client");
    obj.edit68:setField("intimidacao");
    ...
    obj.intimidacaoPlus:setParent(obj.flowLayout32);
    ...
    obj.flowPart150:setParent(obj.tabelaPontosBonus);
    ...
    obj.label70:setParent(obj.flowPart150);
    obj.label70:setText("Persuasão");
    ...
    obj.horzLine81:setParent(obj.flowPart150);
    ...
    obj.flowLayout33:setParent(obj.tabelaPontosBonus);
    obj.flowLayout33:setHeight(20);
    obj.flowLayout33:setMinWidth(150);
    obj.flowLayout33:setMaxWidth(200);
    ...
    obj.persuasaoMinus:setParent(obj.flowLayout33);
    ...
    obj.edit69:setParent(obj.flowPart151);
    obj.edit69:setAlign("client");
    obj.edit69:setField("persuasao");
    ...
    obj.persuasaoPlus:setParent(obj.flowLayout33);
    ...
    obj.flowPart152:setParent(obj.tabelaPontosBonus);
    obj.flowPart152:setHeight(20);
    obj.flowPart152:setMinWidth(180);
    obj.flowPart152:setMaxWidth(180);
    obj.flowPart152:setName("flowPart152");
    obj.flowPart152:setMargins({top=5, bottom=5,right=10});

    obj.label71 = GUI.fromHandle(_obj_newObject("label"));
    obj.label71:setParent(obj.flowPart152);
    obj.label71:setText("Adestrar Animais");
    obj.label71:setAlign("left");
    obj.label71:setFontSize(18);
    obj.label71:setVertTextAlign("center");
    obj.label71:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label71, "fontStyle",  "italic");
    obj.label71:setWidth(200);
    obj.label71:setName("label71");

    obj.horzLine82 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine82:setParent(obj.flowPart152);
    ...
    obj.flowLayout34:setParent(obj.tabelaPontosBonus);
    obj.flowLayout34:setHeight(20);
    obj.flowLayout34:setMinWidth(150);
    obj.flowLayout34:setMaxWidth(200);
    ...
    obj.adestrarAnimaisMinus:setParent(obj.flowLayout34);
    ...
    obj.flowPart153:setMaxWidth(20);
    obj.flowPart153:setName("flowPart153");

    obj.edit70 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit70:setParent(obj.flowPart153);
    obj.edit70:setAlign("client");
    obj.edit70:setField("adestrarAnimais");
    ...
    obj.adestrarAnimaisPlus:setParent(obj.flowLayout34);
    ...
    obj.flowPart154:setParent(obj.tabelaPontosBonus);
    obj.flowPart154:setHeight(20);
    obj.flowPart154:setMinWidth(180);
    obj.flowPart154:setMaxWidth(180);
    obj.flowPart154:setName("flowPart154");
    obj.flowPart154:setMargins({top=5, bottom=5,right=10});

    obj.label72 = GUI.fromHandle(_obj_newObject("label"));
    obj.label72:setParent(obj.flowPart154);
    obj.label72:setText("Furtividade");
    obj.label72:setAlign("left");
    obj.label72:setFontSize(18);
    obj.label72:setVertTextAlign("center");
    obj.label72:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label72, "fontStyle",  "italic");
    obj.label72:setWidth(200);
    obj.label72:setName("label72");

    obj.horzLine83 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine83:setParent(obj.flowPart154);
    ...
    obj.flowLayout35:setParent(obj.tabelaPontosBonus);
    obj.flowLayout35:setHeight(20);
    obj.flowLayout35:setMinWidth(150);
    obj.flowLayout35:setMaxWidth(200);
    ...
    obj.furtividadeMinus:setParent(obj.flowLayout35);
    ...
    obj.flowPart155:setParent(obj.flowLayout35);
    obj.flowPart155:setHeight(20);
    obj.flowPart155:setMinWidth(20);
    obj.flowPart155:setMaxWidth(20);
    obj.flowPart155:setName("flowPart155");

    obj.edit71 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit71:setParent(obj.flowPart155);
    obj.edit71:setAlign("client");
    obj.edit71:setField("furtividade");
    ...
    obj.furtividadePlus:setParent(obj.flowLayout35);
    ...
    obj.flowPart156:setParent(obj.tabelaPontosBonus);
    obj.flowPart156:setHeight(20);
    obj.flowPart156:setMinWidth(180);
    obj.flowPart156:setMaxWidth(180);
    obj.flowPart156:setName("flowPart156");
    obj.flowPart156:setMargins({top=5, bottom=5,right=10});

    obj.label73 = GUI.fromHandle(_obj_newObject("label"));
    obj.label73:setParent(obj.flowPart156);
    obj.label73:setText("Intuição");
    obj.label73:setAlign("left");
    obj.label73:setFontSize(18);
    obj.label73:setVertTextAlign("center");
    obj.label73:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label73, "fontStyle",  "italic");
    obj.label73:setWidth(200);
    obj.label73:setName("label73");

    obj.horzLine84 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine84:setParent(obj.flowPart156);
    ...
    obj.flowLayout36:setParent(obj.tabelaPontosBonus);
    obj.flowLayout36:setHeight(20);
    obj.flowLayout36:setMinWidth(150);
    obj.flowLayout36:setMaxWidth(200);
    ...
    obj.intuicaoMinus:setParent(obj.flowLayout36);
    ...
    obj.flowPart157:setParent(obj.flowLayout36);
    obj.flowPart157:setHeight(20);
    obj.flowPart157:setMinWidth(20);
    obj.flowPart157:setMaxWidth(20);
    obj.flowPart157:setName("flowPart157");

    obj.edit72 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit72:setParent(obj.flowPart157);
    obj.edit72:setAlign("client");
    obj.edit72:setField("intuicao");
    ...
    obj.intuicaoPlus:setParent(obj.flowLayout36);
    ...
    obj.flowPart158:setParent(obj.tabelaPontosBonus);
    obj.flowPart158:setHeight(20);
    obj.flowPart158:setMinWidth(180);
    obj.flowPart158:setMaxWidth(180);
    obj.flowPart158:setName("flowPart158");
    obj.flowPart158:setMargins({top=5, bottom=5,right=10});

    obj.label74 = GUI.fromHandle(_obj_newObject("label"));
    obj.label74:setParent(obj.flowPart158);
    obj.label74:setText("Didática");
    obj.label74:setAlign("left");
    obj.label74:setFontSize(18);
    obj.label74:setVertTextAlign("center");
    obj.label74:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label74, "fontStyle",  "italic");
    obj.label74:setWidth(200);
    obj.label74:setName("label74");

    obj.horzLine85 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine85:setParent(obj.flowPart158);
    ...
    obj.flowLayout37:setParent(obj.tabelaPontosBonus);
    obj.flowLayout37:setHeight(20);
    obj.flowLayout37:setMinWidth(150);
    obj.flowLayout37:setMaxWidth(200);
    ...
    obj.didaticaMinus:setParent(obj.flowLayout37);
    ...
    obj.flowPart159:setParent(obj.flowLayout37);
    obj.flowPart159:setHeight(20);
    obj.flowPart159:setMinWidth(20);
    obj.flowPart159:setMaxWidth(20);
    obj.flowPart159:setName("flowPart159");

    obj.edit73 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit73:setParent(obj.flowPart159);
    obj.edit73:setAlign("client");
    obj.edit73:setField("didatica");
    ...
    obj.didaticaPlus:setParent(obj.flowLayout37);
    ...
    obj.flowPart160:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.flowPart160:setMargins({top=5, bottom=5,right=10});

    obj.label75 = GUI.fromHandle(_obj_newObject("label"));
    obj.label75:setParent(obj.flowPart160);
    obj.label75:setText("Geografia");
    obj.label75:setAlign("left");
    obj.label75:setFontSize(18);
    obj.label75:setVertTextAlign("center");
    obj.label75:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label75, "fontStyle",  "italic");
    obj.label75:setWidth(200);
    obj.label75:setName("label75");

    obj.horzLine86 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine86:setParent(obj.flowPart160);
    ...
    obj.flowLayout38:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout38:setHeight(20);
    obj.flowLayout38:setMinWidth(150);
    obj.flowLayout38:setMaxWidth(200);
    obj.flowLayout38:setMaxControlsPerLine(3);
    obj.flowLayout38:setName("flowLayout38");

    obj.geografiaMinus = GUI.fromHandle(_obj_newObject("button"));
    obj.geografiaMinus:setParent(obj.flowLayout38);
    ...
    obj.flowPart161:setParent(obj.flowLayout38);
    obj.flowPart161:setHeight(20);
    obj.flowPart161:setMinWidth(20);
    obj.flowPart161:setMaxWidth(20);
    obj.flowPart161:setName("flowPart161");

    obj.edit74 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit74:setParent(obj.flowPart161);
    obj.edit74:setAlign("client");
    obj.edit74:setField("geografia");
    ...
    obj.geografiaPlus:setParent(obj.flowLayout38);
    ...
    obj.flowPart162:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.flowPart162:setMargins({top=5, bottom=5,right=10});

    obj.label76 = GUI.fromHandle(_obj_newObject("label"));
    obj.label76:setParent(obj.flowPart162);
    ...
    lfm_setPropAsString(obj.label76, "fontStyle",  "italic");
    obj.label76:setWidth(200);
    obj.label76:setName("label76");

    obj.horzLine87 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine87:setParent(obj.flowPart162);
    ...
    obj.flowLayout39:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout39:setHeight(20);
    obj.flowLayout39:setMinWidth(150);
    obj.flowLayout39:setMaxWidth(200);
    ...
    obj.historiaMinus:setParent(obj.flowLayout39);
    ...
    obj.flowPart163:setParent(obj.flowLayout39);
    obj.flowPart163:setHeight(20);
    obj.flowPart163:setMinWidth(20);
    obj.flowPart163:setMaxWidth(20);
    obj.flowPart163:setName("flowPart163");

    obj.edit75 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit75:setParent(obj.flowPart163);
    obj.edit75:setAlign("client");
    obj.edit75:setField("historia");
    ...
    obj.historiaPlus:setParent(obj.flowLayout39);
    ...
    obj.flowPart164:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.flowPart164:setMargins({top=5, bottom=5,right=10});

    obj.label77 = GUI.fromHandle(_obj_newObject("label"));
    obj.label77:setParent(obj.flowPart164);
    obj.label77:setText("Religião");
    obj.label77:setAlign("left");
    obj.label77:setFontSize(18);
    obj.label77:setVertTextAlign("center");
    obj.label77:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label77, "fontStyle",  "italic");
    obj.label77:setWidth(200);
    obj.label77:setName("label77");

    obj.horzLine88 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine88:setParent(obj.flowPart164);
    ...
    obj.flowLayout40:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout40:setHeight(20);
    obj.flowLayout40:setMinWidth(150);
    obj.flowLayout40:setMaxWidth(200);
    ...
    obj.religiaoMinus:setParent(obj.flowLayout40);
    ...
    obj.flowPart165:setParent(obj.flowLayout40);
    obj.flowPart165:setHeight(20);
    obj.flowPart165:setMinWidth(20);
    obj.flowPart165:setMaxWidth(20);
    obj.flowPart165:setName("flowPart165");

    obj.edit76 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit76:setParent(obj.flowPart165);
    obj.edit76:setAlign("client");
    obj.edit76:setField("religiao");
    ...
    obj.religiaoPlus:setParent(obj.flowLayout40);
    ...
    obj.flowPart166:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.flowPart166:setMargins({top=5, bottom=5,right=10});

    obj.label78 = GUI.fromHandle(_obj_newObject("label"));
    obj.label78:setParent(obj.flowPart166);
    obj.label78:setText("Magia");
    obj.label78:setAlign("left");
    obj.label78:setFontSize(18);
    obj.label78:setVertTextAlign("center");
    obj.label78:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label78, "fontStyle",  "italic");
    obj.label78:setWidth(200);
    obj.label78:setName("label78");

    obj.horzLine89 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine89:setParent(obj.flowPart166);
    ...
    obj.flowLayout41:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout41:setHeight(20);
    obj.flowLayout41:setMinWidth(150);
    obj.flowLayout41:setMaxWidth(200);
    ...
    obj.magiaMinus:setParent(obj.flowLayout41);
    ...
    obj.flowPart167:setParent(obj.flowLayout41);
    obj.flowPart167:setHeight(20);
    obj.flowPart167:setMinWidth(20);
    obj.flowPart167:setMaxWidth(20);
    obj.flowPart167:setName("flowPart167");

    obj.edit77 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit77:setParent(obj.flowPart167);
    obj.edit77:setAlign("client");
    obj.edit77:setField("magia");
    ...
    obj.magiaPlus:setParent(obj.flowLayout41);
    ...
    obj.flowPart168:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart168:setHeight(20);
    obj.flowPart168:setMinWidth(180);
    obj.flowPart168:setMaxWidth(180);
    obj.flowPart168:setName("flowPart168");
    obj.flowPart168:setMargins({top=5, bottom=5,right=10});

    obj.label79 = GUI.fromHandle(_obj_newObject("label"));
    obj.label79:setParent(obj.flowPart168);
    obj.label79:setText("Fauna/Flora");
    obj.label79:setAlign("left");
    obj.label79:setFontSize(18);
    obj.label79:setVertTextAlign("center");
    obj.label79:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label79, "fontStyle",  "italic");
    obj.label79:setWidth(200);
    obj.label79:setName("label79");

    obj.horzLine90 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine90:setParent(obj.flowPart168);
    ...
    obj.flowLayout42:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout42:setHeight(20);
    obj.flowLayout42:setMinWidth(150);
    obj.flowLayout42:setMaxWidth(200);
    obj.flowLayout42:setMaxControlsPerLine(3);
    obj.flowLayout42:setName("flowLayout42");

    obj.faunafloraMinus = GUI.fromHandle(_obj_newObject("button"));
    obj.faunafloraMinus:setParent(obj.flowLayout42);
    ...
    obj.flowPart169:setParent(obj.flowLayout42);
    obj.flowPart169:setHeight(20);
    obj.flowPart169:setMinWidth(20);
    obj.flowPart169:setMaxWidth(20);
    obj.flowPart169:setName("flowPart169");

    obj.edit78 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit78:setParent(obj.flowPart169);
    obj.edit78:setAlign("client");
    obj.edit78:setField("faunaflora");
    ...
    obj.faunafloraPlus:setParent(obj.flowLayout42);
    ...
    obj.flowPart170:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart170:setHeight(20);
    obj.flowPart170:setMinWidth(180);
    obj.flowPart170:setMaxWidth(180);
    obj.flowPart170:setName("flowPart170");
    obj.flowPart170:setMargins({top=5, bottom=5,right=10});

    obj.label80 = GUI.fromHandle(_obj_newObject("label"));
    obj.label80:setParent(obj.flowPart170);
    obj.label80:setText("Lng. Comum");
    ...
    obj.horzLine91:setParent(obj.flowPart170);
    ...
    obj.flowLayout43:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout43:setHeight(20);
    obj.flowLayout43:setMinWidth(150);
    obj.flowLayout43:setMaxWidth(200);
    obj.flowLayout43:setMaxControlsPerLine(3);
    obj.flowLayout43:setName("flowLayout43");

    obj.linguagemComumMinus = GUI.fromHandle(_obj_newObject("button"));
    obj.linguagemComumMinus:setParent(obj.flowLayout43);
    ...
    obj.flowPart171:setParent(obj.flowLayout43);
    obj.flowPart171:setHeight(20);
    obj.flowPart171:setMinWidth(20);
    obj.flowPart171:setMaxWidth(20);
    obj.flowPart171:setName("flowPart171");

    obj.edit79 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit79:setParent(obj.flowPart171);
    obj.edit79:setAlign("client");
    obj.edit79:setField("linguagemComum");
    ...
    obj.linguagemComumPlus:setParent(obj.flowLayout43);
    ...
    obj.flowPart172:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart172:setHeight(20);
    obj.flowPart172:setMinWidth(180);
    obj.flowPart172:setMaxWidth(180);
    obj.flowPart172:setName("flowPart172");
    obj.flowPart172:setMargins({top=5, bottom=5,right=10});

    obj.label81 = GUI.fromHandle(_obj_newObject("label"));
    obj.label81:setParent(obj.flowPart172);
    obj.label81:setText("Lng. Oriental");
    obj.label81:setAlign("left");
    obj.label81:setFontSize(18);
    obj.label81:setVertTextAlign("center");
    obj.label81:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label81, "fontStyle",  "italic");
    obj.label81:setWidth(200);
    obj.label81:setName("label81");

    obj.horzLine92 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine92:setParent(obj.flowPart172);
    ...
    obj.flowLayout44:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout44:setHeight(20);
    obj.flowLayout44:setMinWidth(150);
    obj.flowLayout44:setMaxWidth(200);
    obj.flowLayout44:setMaxControlsPerLine(3);
    obj.flowLayout44:setName("flowLayout44");

    obj.linguagemOrientalMinus = GUI.fromHandle(_obj_newObject("button"));
    obj.linguagemOrientalMinus:setParent(obj.flowLayout44);
    ...
    obj.flowPart173:setParent(obj.flowLayout44);
    obj.flowPart173:setHeight(20);
    obj.flowPart173:setMinWidth(20);
    obj.flowPart173:setMaxWidth(20);
    obj.flowPart173:setName("flowPart173");

    obj.edit80 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit80:setParent(obj.flowPart173);
    obj.edit80:setAlign("client");
    obj.edit80:setField("linguagemOriental");
    ...
    obj.linguagemOrientalPlus:setParent(obj.flowLayout44);
    ...
    obj.flowPart174:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.flowLayout45:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout45:setHeight(20);
    obj.flowLayout45:setMinWidth(150);
    obj.flowLayout45:setMaxWidth(200);
    obj.flowLayout45:setMaxControlsPerLine(3);
    obj.flowLayout45:setName("flowLayout45");

    obj.linguagemElficaMinus = GUI.fromHandle(_obj_newObject("button"));
    obj.linguagemElficaMinus:setParent(obj.flowLayout45);
    ...
    obj.flowPart175:setParent(obj.flowLayout45);
    ...
    obj.edit81:setParent(obj.flowPart175);
    obj.edit81:setAlign("client");
    obj.edit81:setField("linguagemElfica");
    ...
    obj.linguagemElficaPlus:setParent(obj.flowLayout45);
    ...
    obj.flowPart176:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.flowLayout46:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout46:setHeight(20);
    obj.flowLayout46:setMinWidth(150);
    obj.flowLayout46:setMaxWidth(200);
    ...
    obj.linguagemAnaMinus:setParent(obj.flowLayout46);
    ...
    obj.flowPart177:setParent(obj.flowLayout46);
    ...
    obj.edit82:setParent(obj.flowPart177);
    obj.edit82:setAlign("client");
    obj.edit82:setField("linguagemAna");
    ...
    obj.linguagemAnaPlus:setParent(obj.flowLayout46);
    ...
    obj.flowPart178:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.flowLayout47:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout47:setHeight(20);
    obj.flowLayout47:setMinWidth(150);
    obj.flowLayout47:setMaxWidth(200);
    ...
    obj.linguagemDraconicaMinus:setParent(obj.flowLayout47);
    ...
    obj.flowPart179:setParent(obj.flowLayout47);
    ...
    obj.edit83:setParent(obj.flowPart179);
    obj.edit83:setAlign("client");
    obj.edit83:setField("linguagemDraconica");
    ...
    obj.linguagemDraconicaPlus:setParent(obj.flowLayout47);
    ...
    obj.dataLink60:setParent(obj.rectangle16);
    ...
    obj._e_event20 = obj.barraxpClasse:addEventListener("onDblClick",
        function (_)
            self.popupxpClasse:show('bottomCenter', self.barraxpClasse)
                                             self.somaxpClasse:setFocus()
        end, obj);

    obj._e_event21 = obj.somaxpClasse:addEventListener("onKeyDown",
        function (_, event)
    ...
    obj._e_event22 = obj.okButtonClasse:addEventListener("onClick",
        function (_)
    ...
    obj._e_event23 = obj.barraxpProfissao:addEventListener("onDblClick",
        function (_)
            self.popupxpProfissao:show('bottomCenter', self.barraxpProfissao)
                                             self.somaxpProfissao:setFocus()
        end, obj);

    obj._e_event24 = obj.somaxpProfissao:addEventListener("onKeyDown",
        function (_, event)
    ...
    obj._e_event25 = obj.okButtonProfissao:addEventListener("onClick",
        function (_)
    ...
    obj._e_event68 = obj.dataLink47:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intBase == nil then sheet.intBase = 0 end;
        end, obj);

    obj._e_event69 = obj.dataLink48:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intEquip == nil then sheet.intEquip = 0 end;
        end, obj);

    obj._e_event70 = obj.dataLink49:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intTotal == nil then sheet.intTotal = 0 end;
        end, obj);

    obj._e_event71 = obj.dataLink50:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event72 = obj.dataLink51:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabNivel == nil then sheet.sabNivel = 0 end;
        end, obj);

    obj._e_event73 = obj.dataLink52:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabClasse == nil then sheet.sabClasse = 0 end;
        end, obj);

    obj._e_event74 = obj.dataLink53:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabRaca == nil then sheet.sabRaca = 0 end;
        end, obj);

    obj._e_event75 = obj.dataLink54:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabTreino == nil then sheet.sabTreino = 0 end;
        end, obj);

    obj._e_event76 = obj.dataLink55:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabOutros == nil then sheet.sabOutros = 0 end;
        end, obj);

    obj._e_event77 = obj.dataLink56:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabBase == nil then sheet.sabBase = 0 end;
        end, obj);

    obj._e_event78 = obj.dataLink57:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabEquip == nil then sheet.sabEquip = 0 end;
        end, obj);

    obj._e_event79 = obj.dataLink58:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabTotal == nil then sheet.sabTotal = 0 end;
        end, obj);

    obj._e_event80 = obj.dataLink59:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event81 = obj.percepcaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event82 = obj.percepcaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event83 = obj.intimidacaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event84 = obj.intimidacaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event85 = obj.persuasaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event86 = obj.persuasaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event87 = obj.adestrarAnimaisMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event88 = obj.adestrarAnimaisPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event89 = obj.furtividadeMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event90 = obj.furtividadePlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event91 = obj.intuicaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event92 = obj.intuicaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event93 = obj.didaticaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event94 = obj.didaticaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event95 = obj.geografiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event96 = obj.geografiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event97 = obj.historiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event98 = obj.historiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event99 = obj.religiaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event100 = obj.religiaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event101 = obj.magiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event102 = obj.magiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event103 = obj.faunafloraMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event104 = obj.faunafloraPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event105 = obj.linguagemComumMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event106 = obj.linguagemComumPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event107 = obj.linguagemOrientalMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event108 = obj.linguagemOrientalPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event109 = obj.linguagemElficaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event110 = obj.linguagemElficaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event111 = obj.linguagemAnaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event112 = obj.linguagemAnaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event113 = obj.linguagemDraconicaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event114 = obj.linguagemDraconicaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event115 = obj.dataLink60:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            -- ###### REMOVE VALORES NULOS ######
                        ...
                        sheet.destrezaDisponivel = sheet.dexBase - (
