...
local function constructNew_frmFichaDePersonagem()
    ...
    obj.button1:setText("Descanço Longo");
    ...
    obj.hab1 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.hab1:setParent(obj.habilidadesLayout);
    obj.hab1:setCornerType("innerLine");
    obj.hab1:setAlign("client");
    obj.hab1:setName("hab1");
    obj.hab1:setXradius(10);
    obj.hab1:setYradius(10);
    obj.hab1:setMargins({left=5,right=5,top=5,bottom=5});
    obj.hab1:setHeight(60);
    obj.hab1:setWidth(400);
    obj.hab1:setColor("#40000000");
    obj.hab1:setStrokeColor("black");
    obj.hab1:setStrokeSize(2);

    obj.flowLayout1 = GUI.fromHandle(_obj_newObject("flowLayout"));
    obj.flowLayout1:setParent(obj.hab1);
    ...
    obj.comboBox1:setField("rankhab1");
    ...
    obj.popuphab1 = GUI.fromHandle(_obj_newObject("popup"));
    obj.popuphab1:setParent(obj.habilidadesLayout);
    obj.popuphab1:setName("popuphab1");
    obj.popuphab1:setHeight(400);
    obj.popuphab1:setWidth(752);

    obj.flowLayout3 = GUI.fromHandle(_obj_newObject("flowLayout"));
    obj.flowLayout3:setParent(obj.popuphab1);
    ...
    obj.richEdit1:setField("testehab1");
    ...
    obj.edit3:setField("cargasMaxhab1");
    ...
    obj.hab2 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.hab2:setParent(obj.habilidadesLayout);
    obj.hab2:setCornerType("innerLine");
    obj.hab2:setAlign("client");
    obj.hab2:setName("hab2");
    obj.hab2:setXradius(10);
    obj.hab2:setYradius(10);
    obj.hab2:setMargins({left=5,right=5,top=5,bottom=5});
    obj.hab2:setHeight(60);
    obj.hab2:setWidth(400);
    obj.hab2:setColor("#40000000");
    obj.hab2:setStrokeColor("black");
    obj.hab2:setStrokeSize(2);

    obj.flowLayout5 = GUI.fromHandle(_obj_newObject("flowLayout"));
    obj.flowLayout5:setParent(obj.hab2);
    obj.flowLayout5:setHeight(60);
    obj.flowLayout5:setWidth(400);
    obj.flowLayout5:setMaxControlsPerLine(3);
    obj.flowLayout5:setName("flowLayout5");

    obj.flowPart4 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart4:setParent(obj.flowLayout5);
    obj.flowPart4:setWidth(280);
    obj.flowPart4:setHeight(25);
    obj.flowPart4:setAlign("left");
    obj.flowPart4:setMargins({left=10,top=5});
    obj.flowPart4:setName("flowPart4");

    obj.edit4 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit4:setParent(obj.flowPart4);
    obj.edit4:setTextPrompt("Nome da Habilidade");
    obj.edit4:setFontSize(15);
    obj.edit4:setTransparent(true);
    obj.edit4:setField("nomehab2");
    ...
    obj.horzLine3:setParent(obj.flowPart4);
    ...
    obj.comboBox2:setItems({'', 'C', 'C+','B', 'B+', 'A', 'A+', 'S', 'S+'});
    obj.comboBox2:setField("rankhab2");
    ...
    obj.flowPart5:setWidth(30);
    obj.flowPart5:setAlign("right");
    obj.flowPart5:setMargins({right=10, top=5});
    ...
    obj.button6:setParent(obj.flowLayout6);
    obj.button6:setText("editar");
    ...
    obj.button7:setParent(obj.flowLayout6);
    ...
    obj.popuphab2 = GUI.fromHandle(_obj_newObject("popup"));
    obj.popuphab2:setParent(obj.habilidadesLayout);
    obj.popuphab2:setName("popuphab2");
    obj.popuphab2:setHeight(400);
    obj.popuphab2:setWidth(752);

    obj.flowLayout7 = GUI.fromHandle(_obj_newObject("flowLayout"));
    obj.flowLayout7:setParent(obj.popuphab2);
    obj.flowLayout7:setAlign("client");
    obj.flowLayout7:setMaxControlsPerLine(1);
    obj.flowLayout7:setMargins({left=10,right=10,top=10,bottom=10});
    obj.flowLayout7:setName("flowLayout7");

    obj.rectangle7 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle7:setParent(obj.flowLayout7);
    ...
    obj.flowLayout8:setParent(obj.rectangle7);
    obj.flowLayout8:setHeight(200);
    obj.flowLayout8:setWidth(732);
    obj.flowLayout8:setPadding({left=10,right=10,top=10,bottom=10});
    obj.flowLayout8:setAlign("client");
    obj.flowLayout8:setName("flowLayout8");

    obj.richEdit2 = GUI.fromHandle(_obj_newObject("richEdit"));
    obj.richEdit2:setParent(obj.flowLayout8);
    obj.richEdit2:setField("testehab2");
    obj.richEdit2:setHeight(200);
    obj.richEdit2:setWidth(712);
    ...
    obj.flowPart6:setParent(obj.flowLayout7);
    obj.flowPart6:setWidth(135);
    obj.flowPart6:setHeight(20);
    obj.flowPart6:setName("flowPart6");

    obj.label2 = GUI.fromHandle(_obj_newObject("label"));
    obj.label2:setParent(obj.flowPart6);
    obj.label2:setText("Máximo de Cargas:");
    ...
    obj.edit6:setField("cargasMaxhab2");
    obj.edit6:setName("edit6");

    obj.horzLine4 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine4:setParent(obj.flowPart6);
    ...
    obj.hab3 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.hab3:setParent(obj.habilidadesLayout);
    obj.hab3:setCornerType("innerLine");
    obj.hab3:setAlign("client");
    obj.hab3:setName("hab3");
    obj.hab3:setXradius(10);
    obj.hab3:setYradius(10);
    obj.hab3:setMargins({left=5,right=5,top=5,bottom=5});
    obj.hab3:setHeight(60);
    obj.hab3:setWidth(400);
    obj.hab3:setColor("#40000000");
    obj.hab3:setStrokeColor("black");
    obj.hab3:setStrokeSize(2);

    obj.flowLayout9 = GUI.fromHandle(_obj_newObject("flowLayout"));
    obj.flowLayout9:setParent(obj.hab3);
    obj.flowLayout9:setHeight(60);
    obj.flowLayout9:setWidth(400);
    obj.flowLayout9:setMaxControlsPerLine(3);
    obj.flowLayout9:setName("flowLayout9");

    obj.flowPart7 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart7:setParent(obj.flowLayout9);
    obj.flowPart7:setWidth(280);
    obj.flowPart7:setHeight(25);
    obj.flowPart7:setAlign("left");
    obj.flowPart7:setMargins({left=10,top=5});
    obj.flowPart7:setName("flowPart7");

    obj.edit7 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit7:setParent(obj.flowPart7);
    obj.edit7:setTextPrompt("Nome da Habilidade");
    obj.edit7:setFontSize(15);
    obj.edit7:setTransparent(true);
    obj.edit7:setField("nomehab3");
    ...
    obj.horzLine5:setParent(obj.flowPart7);
    ...
    obj.comboBox3:setItems({'', 'C', 'C+','B', 'B+', 'A', 'A+', 'S', 'S+'});
    obj.comboBox3:setField("rankhab3");
    obj.comboBox3:setTransparent(true);
    obj.comboBox3:setName("comboBox3");

    obj.flowPart8 = GUI.fromHandle(_obj_newObject("flowPart"));
    obj.flowPart8:setParent(obj.flowLayout9);
    obj.flowPart8:setHeight(20);
    obj.flowPart8:setWidth(30);
    obj.flowPart8:setAlign("right");
    obj.flowPart8:setMargins({right=10, top=5});
    ...
    obj.button10:setParent(obj.flowLayout10);
    obj.button10:setText("i");
    obj.button10:setHeight(20);
    obj.button10:setWidth(20);
    obj.button10:setMargins({left=5,right=5});
    obj.button10:setName("button10");

    obj.popuphab3 = GUI.fromHandle(_obj_newObject("popup"));
    obj.popuphab3:setParent(obj.habilidadesLayout);
    obj.popuphab3:setName("popuphab3");
    obj.popuphab3:setHeight(400);
    obj.popuphab3:setWidth(752);

    obj.flowLayout11 = GUI.fromHandle(_obj_newObject("flowLayout"));
    obj.flowLayout11:setParent(obj.popuphab3);
    obj.flowLayout11:setAlign("client");
    obj.flowLayout11:setMaxControlsPerLine(1);
    obj.flowLayout11:setMargins({left=10,right=10,top=10,bottom=10});
    obj.flowLayout11:setName("flowLayout11");

    obj.rectangle10 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle10:setParent(obj.flowLayout11);
    obj.rectangle10:setCornerType("innerLine");
    obj.rectangle10:setXradius(10);
    obj.rectangle10:setYradius(10);
    obj.rectangle10:setHeight(200);
    obj.rectangle10:setWidth(732);
    obj.rectangle10:setColor("silver");
    ...
    obj.flowLayout12:setParent(obj.rectangle10);
    obj.flowLayout12:setHeight(200);
    obj.flowLayout12:setWidth(732);
    obj.flowLayout12:setPadding({left=10,right=10,top=10,bottom=10});
    ...
    obj.richEdit3:setParent(obj.flowLayout12);
    obj.richEdit3:setField("testehab3");
    obj.richEdit3:setHeight(200);
    obj.richEdit3:setWidth(712);
    ...
    obj.flowPart9:setParent(obj.flowLayout11);
    obj.flowPart9:setWidth(135);
    obj.flowPart9:setHeight(20);
    obj.flowPart9:setName("flowPart9");

    obj.label3 = GUI.fromHandle(_obj_newObject("label"));
    obj.label3:setParent(obj.flowPart9);
    obj.label3:setText("Máximo de Cargas:");
    ...
    obj.edit9:setField("cargasMaxhab3");
    obj.edit9:setName("edit9");

    obj.horzLine6 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine6:setParent(obj.flowPart9);
    ...
    obj.rectangle11:setParent(obj.tab2);
    ...
    obj.scrollBox2:setParent(obj.rectangle11);
    obj.scrollBox2:setAlign("client");
    obj.scrollBox2:setName("scrollBox2");

    obj.button11 = GUI.fromHandle(_obj_newObject("button"));
    obj.button11:setParent(obj.scrollBox2);
    obj.button11:setText("Inicia");
    ...
    obj.rectangle12:setParent(obj.imagemDoPersonagem);
    ...
    obj.edit10:setParent(obj.nome);
    obj.edit10:setAlign("top");
    obj.edit10:setField("nome");
    ...
    obj.horzLine7:setParent(obj.nome);
    ...
    obj.flowPart10:setParent(obj.dadosNomeNivel);
    ...
    obj.edit11:setParent(obj.flowPart10);
    obj.edit11:setAlign("top");
    obj.edit11:setField("raca");
    ...
    obj.horzLine8:setParent(obj.flowPart10);
    ...
    obj.label5:setParent(obj.flowPart10);
    ...
    obj.flowPart11:setParent(obj.dadosNomeNivel);
    ...
    obj.flowPart11:setMaxScaledWidth(400);
    obj.flowPart11:setAvoidScale(true);
    obj.flowPart11:setName("flowPart11");

    obj.edit12 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit12:setParent(obj.flowPart11);
    obj.edit12:setAlign("top");
    obj.edit12:setField("classe");
    ...
    obj.horzLine9:setParent(obj.flowPart11);
    ...
    obj.rectangle13:setParent(obj.dadosDeNivel);
    obj.rectangle13:setCornerType("bevel");
    obj.rectangle13:setAlign("client");
    obj.rectangle13:setYradius(100);
    obj.rectangle13:setXradius(20);
    obj.rectangle13:setStrokeColor("silver");
    obj.rectangle13:setStrokeSize(2);
    obj.rectangle13:setHeight(75);
    obj.rectangle13:setWidth(100);
    obj.rectangle13:setColor("black");
    obj.rectangle13:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle13:setName("rectangle13");

    obj.label7 = GUI.fromHandle(_obj_newObject("label"));
    obj.label7:setParent(obj.rectangle13);
    obj.label7:setAlign("client");
    obj.label7:setField("nivelClasse");
    ...
    obj.label7:setMargins({top=10});
    obj.label7:setName("label7");

    obj.label8 = GUI.fromHandle(_obj_newObject("label"));
    obj.label8:setParent(obj.rectangle13);
    ...
    obj.rectangle14:setParent(obj.dadosDeNivel);
    obj.rectangle14:setCornerType("bevel");
    obj.rectangle14:setAlign("client");
    obj.rectangle14:setYradius(100);
    obj.rectangle14:setXradius(20);
    obj.rectangle14:setStrokeColor("silver");
    obj.rectangle14:setStrokeSize(2);
    obj.rectangle14:setHeight(75);
    obj.rectangle14:setWidth(100);
    obj.rectangle14:setColor("black");
    obj.rectangle14:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle14:setName("rectangle14");

    obj.label9 = GUI.fromHandle(_obj_newObject("label"));
    obj.label9:setParent(obj.rectangle14);
    obj.label9:setAlign("client");
    obj.label9:setField("nivelProfissao");
    ...
    obj.button12:setParent(obj.dadosDeNivel);
    ...
    obj.label12:setParent(obj.rectangle15);
    obj.label12:setText("P.Destino");
    obj.label12:setVertTextAlign("trailing");
    obj.label12:setHorzTextAlign("center");
    obj.label12:setAlign("bottom");
    obj.label12:setMargins({bottom=5});
    obj.label12:setFontSize(14);
    obj.label12:setName("label12");

    obj.button13 = GUI.fromHandle(_obj_newObject("button"));
    obj.button13:setParent(obj.dadosDeNivel);
    ...
    obj.flowPart12:setParent(obj.dadosGerais);
    ...
    obj.edit13:setParent(obj.flowPart12);
    obj.edit13:setAlign("top");
    obj.edit13:setField("peso");
    ...
    obj.flowPart13:setParent(obj.dadosGerais);
    obj.flowPart13:setHeight(50);
    obj.flowPart13:setMinScaledWidth(100);
    obj.flowPart13:setMinWidth(100);
    obj.flowPart13:setMaxWidth(233);
    obj.flowPart13:setMaxScaledWidth(233);
    obj.flowPart13:setAvoidScale(true);
    obj.flowPart13:setName("flowPart13");

    obj.edit14 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit14:setParent(obj.flowPart13);
    obj.edit14:setAlign("top");
    obj.edit14:setField("altura");
    ...
    obj.flowPart14:setParent(obj.dadosGerais);
    obj.flowPart14:setHeight(50);
    obj.flowPart14:setMinScaledWidth(100);
    obj.flowPart14:setMinWidth(100);
    obj.flowPart14:setMaxWidth(233);
    obj.flowPart14:setMaxScaledWidth(233);
    obj.flowPart14:setAvoidScale(true);
    obj.flowPart14:setName("flowPart14");

    obj.edit15 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit15:setParent(obj.flowPart14);
    obj.edit15:setAlign("top");
    obj.edit15:setField("idade");
    ...
    obj.flowPart15:setParent(obj.dadosGerais);
    obj.flowPart15:setHeight(50);
    obj.flowPart15:setMinScaledWidth(100);
    obj.flowPart15:setMinWidth(100);
    obj.flowPart15:setMaxWidth(233);
    obj.flowPart15:setMaxScaledWidth(233);
    obj.flowPart15:setAvoidScale(true);
    obj.flowPart15:setName("flowPart15");

    obj.edit16 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit16:setParent(obj.flowPart15);
    obj.edit16:setAlign("top");
    obj.edit16:setField("sexo");
    ...
    obj.flowPart16:setParent(obj.dadosGerais);
    obj.flowPart16:setHeight(50);
    obj.flowPart16:setMinScaledWidth(100);
    obj.flowPart16:setMinWidth(100);
    obj.flowPart16:setMaxWidth(233);
    obj.flowPart16:setMaxScaledWidth(233);
    obj.flowPart16:setAvoidScale(true);
    obj.flowPart16:setName("flowPart16");

    obj.edit17 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit17:setParent(obj.flowPart16);
    obj.edit17:setAlign("top");
    obj.edit17:setField("nacionalidade");
    ...
    obj.horzLine14:setParent(obj.flowPart16);
    ...
    obj.label17:setText("Nacionalidade");
    ...
    obj.flowPart17:setParent(obj.dadosGerais);
    obj.flowPart17:setHeight(50);
    obj.flowPart17:setMinScaledWidth(100);
    obj.flowPart17:setMinWidth(100);
    obj.flowPart17:setMaxWidth(233);
    obj.flowPart17:setMaxScaledWidth(233);
    obj.flowPart17:setAvoidScale(true);
    obj.flowPart17:setName("flowPart17");

    obj.edit18 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit18:setParent(obj.flowPart17);
    obj.edit18:setAlign("top");
    obj.edit18:setField("divindade");
    ...
    obj.horzLine15:setParent(obj.flowPart17);
    ...
    obj.label18:setParent(obj.flowPart17);
    obj.label18:setAlign("top");
    obj.label18:setText("Divindade");
    ...
    obj.rectangle16:setParent(obj.vidaEDefesa);
    ...
    obj.rectangle16:setMargins({top=2, bottom=2, left=2, right=2});
    ...
    lfm_setPropAsString(obj.label19, "fontStyle",  "italic bold");
    ...
    obj.label20:setField("atributoVida");
    obj.label20:setHorzTextAlign("trailing");
    obj.label20:setMargins({right=8, top=5});
    ...
    obj.rectangle17:setWidth(100);
    obj.rectangle17:setColor("black");
    obj.rectangle17:setMargins({top=2, bottom=2, left=2, right=2});
    obj.rectangle17:setName("rectangle17");

    obj.label21 = GUI.fromHandle(_obj_newObject("label"));
    obj.label21:setParent(obj.rectangle17);
    obj.label21:setAlign("client");
    obj.label21:setHorzTextAlign("leading");
    obj.label21:setText("Defesa:");
    obj.label21:setMargins({left=5, top=5});
    obj.label21:setVertTextAlign("center");
    obj.label21:setFontSize(16);
    lfm_setPropAsString(obj.label21, "fontStyle",  "italic bold");
    obj.label21:setWidth(60);
    obj.label21:setHeight(20);
    obj.label21:setName("label21");

    obj.label22 = GUI.fromHandle(_obj_newObject("label"));
    obj.label22:setParent(obj.rectangle17);
    obj.label22:setAlign("client");
    obj.label22:setField("atributoDefesa");
    obj.label22:setHorzTextAlign("trailing");
    obj.label22:setMargins({right=8, top=5});
    obj.label22:setVertTextAlign("center");
    obj.label22:setFontSize(17);
    ...
    obj.rectangle18:setParent(obj.atributosDestreza);
    ...
    obj.edit19:setParent(obj.rectangle18);
    obj.edit19:setAlign("top");
    obj.edit19:setField("atributoAcerto");
    ...
    obj.label23:setParent(obj.rectangle18);
    obj.label23:setAlign("client");
    obj.label23:setField("modAcerto");
    ...
    obj.label23:setMargins({bottom=8});
    obj.label23:setName("label23");

    obj.label24 = GUI.fromHandle(_obj_newObject("label"));
    obj.label24:setParent(obj.rectangle18);
    ...
    obj.rectangle19:setParent(obj.atributosDestreza);
    ...
    obj.edit20:setParent(obj.rectangle19);
    ...
    obj.label25:setParent(obj.rectangle19);
    obj.label25:setAlign("client");
    obj.label25:setField("modMira");
    ...
    obj.label25:setMargins({bottom=8});
    obj.label25:setName("label25");

    obj.label26 = GUI.fromHandle(_obj_newObject("label"));
    obj.label26:setParent(obj.rectangle19);
    obj.label26:setText("Mira");
    ...
    obj.rectangle20:setParent(obj.atributosDestreza);
    ...
    obj.rectangle20:setMargins({left=2.5});
    obj.rectangle20:setName("rectangle20");

    obj.label27 = GUI.fromHandle(_obj_newObject("label"));
    obj.label27:setParent(obj.rectangle20);
    obj.label27:setField("destrezaDisponivel");
    ...
    obj.rectangle21:setParent(obj.atributosDestreza);
    ...
    obj.edit21:setParent(obj.rectangle21);
    obj.edit21:setAlign("top");
    obj.edit21:setField("atributoEsquiva");
    ...
    obj.label28:setParent(obj.rectangle21);
    obj.label28:setAlign("client");
    obj.label28:setField("modEsquiva");
    ...
    obj.label28:setMargins({bottom=8});
    obj.label28:setName("label28");

    obj.label29 = GUI.fromHandle(_obj_newObject("label"));
    obj.label29:setParent(obj.rectangle21);
    ...
    obj.rectangle22:setParent(obj.atributosDestreza);
    ...
    obj.edit22:setParent(obj.rectangle22);
    obj.edit22:setAlign("top");
    obj.edit22:setField("atributoBloqueio");
    ...
    obj.label30:setParent(obj.rectangle22);
    obj.label30:setAlign("client");
    obj.label30:setField("modBloqueio");
    ...
    obj.label30:setMargins({bottom=8});
    obj.label30:setName("label30");

    obj.label31 = GUI.fromHandle(_obj_newObject("label"));
    obj.label31:setParent(obj.rectangle22);
    obj.label31:setText("Bloqueio");
    ...
    obj.label32:setParent(obj.dadosAdicionais);
    obj.label32:setWidth(300);
    obj.label32:setHeight(5);
    obj.label32:setFontSize(12);
    obj.label32:setText("Experiência de Classe:");
    obj.label32:setHorzTextAlign("center");
    obj.label32:setVertTextAlign("leading");
    obj.label32:setMargins({top=5,bottom=5});
    ...
    obj.label33:setParent(obj.dadosAdicionais);
    obj.label33:setWidth(250);
    obj.label33:setHeight(5);
    obj.label33:setFontSize(12);
    obj.label33:setHorzTextAlign("trailing");
    obj.label33:setVertTextAlign("trailing");
    obj.label33:setMargins({top=5,bottom=5});
    obj.label33:setField("xpTextoClasse");
    ...
    obj.flowLayout13:setParent(obj.popupxpClasse);
    obj.flowLayout13:setWidth(250);
    obj.flowLayout13:setHeight(30);
    obj.flowLayout13:setMaxControlsPerLine(3);
    obj.flowLayout13:setName("flowLayout13");

    obj.label34 = GUI.fromHandle(_obj_newObject("label"));
    obj.label34:setParent(obj.flowLayout13);
    obj.label34:setText("Adicionar Experiência: ");
    ...
    obj.label35:setParent(obj.dadosAdicionais);
    obj.label35:setWidth(300);
    obj.label35:setHeight(5);
    obj.label35:setFontSize(12);
    obj.label35:setText("Experiência de Profissão:");
    obj.label35:setHorzTextAlign("center");
    obj.label35:setVertTextAlign("leading");
    obj.label35:setMargins({top=5,bottom=5});
    ...
    obj.label36:setParent(obj.dadosAdicionais);
    obj.label36:setWidth(250);
    obj.label36:setHeight(5);
    obj.label36:setFontSize(12);
    obj.label36:setHorzTextAlign("trailing");
    obj.label36:setVertTextAlign("trailing");
    obj.label36:setMargins({top=5,bottom=5});
    obj.label36:setField("xpTextoProfissao");
    ...
    obj.flowLayout14:setParent(obj.popupxpProfissao);
    obj.flowLayout14:setWidth(250);
    obj.flowLayout14:setHeight(30);
    obj.flowLayout14:setMaxControlsPerLine(3);
    obj.flowLayout14:setName("flowLayout14");

    obj.label37 = GUI.fromHandle(_obj_newObject("label"));
    obj.label37:setParent(obj.flowLayout14);
    obj.label37:setText("Adicionar Experiência: ");
    ...
    obj.flowPart20:setParent(obj.perfilLayout);
    obj.flowPart20:setHeight(2);
    obj.flowPart20:setMinScaledWidth(100);
    obj.flowPart20:setMaxScaledWidth(1600);
    obj.flowPart20:setName("flowPart20");

    obj.horzLine20 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine20:setParent(obj.flowPart20);
    obj.horzLine20:setStrokeColor("#FFFFFF50");
    obj.horzLine20:setStrokeSize(0.6);
    obj.horzLine20:setStrokeCap("round");
    obj.horzLine20:setScaleY(0.1);
    obj.horzLine20:setTop(1);
    ...
    obj.flowPart21:setParent(obj.perfilLayout);
    obj.flowPart21:setWidth(140);
    ...
    obj.flowPart23:setParent(obj.topoAtributos);
    ...
    obj.label39:setParent(obj.flowPart23);
    obj.label39:setText("Classe");
    obj.label39:setAlign("client");
    obj.label39:setField("");
    obj.label39:setFontSize(8);
    ...
    obj.flowPart24:setParent(obj.topoAtributos);
    obj.flowPart24:setHeight(20);
    obj.flowPart24:setMinScaledWidth(60);
    obj.flowPart24:setMaxScaledWidth(85);
    obj.flowPart24:setName("flowPart24");

    obj.label40 = GUI.fromHandle(_obj_newObject("label"));
    obj.label40:setParent(obj.flowPart24);
    obj.label40:setText("Raça");
    ...
    obj.flowPart25:setParent(obj.topoAtributos);
    obj.flowPart25:setHeight(20);
    obj.flowPart25:setMinScaledWidth(60);
    obj.flowPart25:setMaxScaledWidth(85);
    obj.flowPart25:setName("flowPart25");

    obj.label41 = GUI.fromHandle(_obj_newObject("label"));
    obj.label41:setParent(obj.flowPart25);
    obj.label41:setText("Treino");
    obj.label41:setAlign("client");
    obj.label41:setField("");
    obj.label41:setFontSize(8);
    ...
    obj.flowPart26:setParent(obj.topoAtributos);
    obj.flowPart26:setHeight(20);
    obj.flowPart26:setMinScaledWidth(60);
    obj.flowPart26:setMaxScaledWidth(85);
    obj.flowPart26:setName("flowPart26");

    obj.label42 = GUI.fromHandle(_obj_newObject("label"));
    obj.label42:setParent(obj.flowPart26);
    obj.label42:setText("Outros");
    obj.label42:setAlign("client");
    obj.label42:setField("");
    obj.label42:setFontSize(8);
    ...
    obj.flowPart27:setParent(obj.topoAtributos);
    ...
    obj.flowPart28:setParent(obj.topoAtributos);
    obj.flowPart28:setHeight(20);
    obj.flowPart28:setMinScaledWidth(60);
    obj.flowPart28:setMaxScaledWidth(85);
    obj.flowPart28:setName("flowPart28");

    obj.label44 = GUI.fromHandle(_obj_newObject("label"));
    obj.label44:setParent(obj.flowPart28);
    obj.label44:setText("Equip.");
    obj.label44:setAlign("client");
    obj.label44:setField("");
    obj.label44:setFontSize(8);
    ...
    obj.flowPart29:setParent(obj.topoAtributos);
    obj.flowPart29:setHeight(20);
    obj.flowPart29:setMinScaledWidth(60);
    obj.flowPart29:setMaxScaledWidth(85);
    obj.flowPart29:setName("flowPart29");

    obj.label45 = GUI.fromHandle(_obj_newObject("label"));
    obj.label45:setParent(obj.flowPart29);
    obj.label45:setText("Total");
    obj.label45:setAlign("client");
    obj.label45:setField("");
    obj.label45:setFontSize(8);
    ...
    obj.flowPart30:setMinScaledWidth(60);
    obj.flowPart30:setMaxScaledWidth(85);
    obj.flowPart30:setName("flowPart30");

    obj.label46 = GUI.fromHandle(_obj_newObject("label"));
    obj.label46:setParent(obj.flowPart30);
    obj.label46:setText("Constituição");
    obj.label46:setAlign("client");
    obj.label46:setField("");
    obj.label46:setFontSize(8);
    ...
    obj.flowPart31:setMaxWidth(35);
    obj.flowPart31:setMaxScaledWidth(35);
    ...
    obj.horzLine21:setParent(obj.flowPart31);
    ...
    obj.image2:setParent(obj.flowPart32);
    ...
    obj.flowPart33:setMaxWidth(35);
    obj.flowPart33:setMaxScaledWidth(35);
    ...
    obj.horzLine22:setParent(obj.flowPart33);
    ...
    obj.image3:setParent(obj.flowPart34);
    ...
    obj.flowPart35:setMaxWidth(35);
    obj.flowPart35:setMaxScaledWidth(35);
    ...
    obj.image4:setParent(obj.flowPart36);
    ...
    obj.flowPart37:setMaxWidth(35);
    obj.flowPart37:setMaxScaledWidth(35);
    ...
    obj.horzLine24:setParent(obj.flowPart37);
    ...
    obj.image5:setParent(obj.flowPart38);
    ...
    obj.flowPart39:setMaxWidth(35);
    obj.flowPart39:setMaxScaledWidth(35);
    ...
    obj.horzLine25:setParent(obj.flowPart39);
    ...
    obj.image6:setParent(obj.flowPart40);
    ...
    obj.flowPart41:setMaxWidth(35);
    obj.flowPart41:setMaxScaledWidth(35);
    obj.flowPart41:setAvoidScale(true);
    obj.flowPart41:setName("flowPart41");

    obj.edit28 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit28:setParent(obj.flowPart41);
    obj.edit28:setAlign("top");
    obj.edit28:setField("conBase");
    ...
    obj.horzLine26:setParent(obj.flowPart41);
    ...
    obj.image7:setParent(obj.flowPart42);
    ...
    obj.flowPart43:setMaxWidth(35);
    obj.flowPart43:setMaxScaledWidth(35);
    ...
    obj.horzLine27:setParent(obj.flowPart43);
    ...
    obj.image8:setParent(obj.flowPart44);
    ...
    obj.flowPart45:setMaxWidth(35);
    obj.flowPart45:setMaxScaledWidth(35);
    ...
    obj.horzLine28:setParent(obj.flowPart45);
    ...
    obj.label47:setParent(obj.flowPart46);
    obj.label47:setText("Força");
    obj.label47:setAlign("client");
    obj.label47:setField("");
    obj.label47:setFontSize(8);
    ...
    obj.flowPart47:setMaxWidth(35);
    obj.flowPart47:setMaxScaledWidth(35);
    ...
    obj.horzLine29:setParent(obj.flowPart47);
    ...
    obj.image9:setParent(obj.flowPart48);
    ...
    obj.flowPart49:setMaxWidth(35);
    obj.flowPart49:setMaxScaledWidth(35);
    obj.flowPart49:setAvoidScale(true);
    obj.flowPart49:setName("flowPart49");

    obj.edit32 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit32:setParent(obj.flowPart49);
    obj.edit32:setAlign("top");
    obj.edit32:setField("forClasse");
    ...
    obj.horzLine30:setParent(obj.flowPart49);
    ...
    obj.image10:setParent(obj.flowPart50);
    ...
    obj.flowPart51:setMaxWidth(35);
    obj.flowPart51:setMaxScaledWidth(35);
    obj.flowPart51:setAvoidScale(true);
    obj.flowPart51:setName("flowPart51");

    obj.edit33 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit33:setParent(obj.flowPart51);
    obj.edit33:setAlign("top");
    obj.edit33:setField("forRaca");
    ...
    obj.horzLine31:setParent(obj.flowPart51);
    ...
    obj.image11:setParent(obj.flowPart52);
    ...
    obj.flowPart53:setMaxWidth(35);
    obj.flowPart53:setMaxScaledWidth(35);
    obj.flowPart53:setAvoidScale(true);
    obj.flowPart53:setName("flowPart53");

    obj.edit34 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit34:setParent(obj.flowPart53);
    obj.edit34:setAlign("top");
    obj.edit34:setField("forTreino");
    ...
    obj.horzLine32:setParent(obj.flowPart53);
    ...
    obj.image12:setParent(obj.flowPart54);
    ...
    obj.flowPart55:setMaxWidth(35);
    obj.flowPart55:setMaxScaledWidth(35);
    obj.flowPart55:setAvoidScale(true);
    obj.flowPart55:setName("flowPart55");

    obj.edit35 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit35:setParent(obj.flowPart55);
    obj.edit35:setAlign("top");
    obj.edit35:setField("forOutros");
    ...
    obj.horzLine33:setParent(obj.flowPart55);
    ...
    obj.image13:setParent(obj.flowPart56);
    ...
    obj.flowPart57:setMaxWidth(35);
    obj.flowPart57:setMaxScaledWidth(35);
    ...
    obj.horzLine34:setParent(obj.flowPart57);
    ...
    obj.image14:setParent(obj.flowPart58);
    ...
    obj.flowPart59:setMaxWidth(35);
    obj.flowPart59:setMaxScaledWidth(35);
    ...
    obj.horzLine35:setParent(obj.flowPart59);
    ...
    obj.flowPart60:setMaxScaledWidth(50);

    obj.image15 = GUI.fromHandle(_obj_newObject("image"));
    obj.image15:setParent(obj.flowPart60);
    ...
    obj.flowPart61:setMaxWidth(35);
    obj.flowPart61:setMaxScaledWidth(35);
    obj.flowPart61:setAvoidScale(true);
    obj.flowPart61:setName("flowPart61");

    obj.edit38 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit38:setParent(obj.flowPart61);
    obj.edit38:setAlign("top");
    obj.edit38:setField("forTotal");
    ...
    obj.horzLine36:setParent(obj.flowPart61);
    ...
    obj.flowPart62:setMinScaledWidth(60);
    obj.flowPart62:setMaxScaledWidth(85);
    obj.flowPart62:setName("flowPart62");

    obj.label48 = GUI.fromHandle(_obj_newObject("label"));
    obj.label48:setParent(obj.flowPart62);
    obj.label48:setText("Destreza");
    obj.label48:setAlign("client");
    obj.label48:setField("");
    obj.label48:setFontSize(8);
    ...
    obj.flowPart63:setMinWidth(30);
    obj.flowPart63:setMaxWidth(35);
    obj.flowPart63:setMaxScaledWidth(35);
    obj.flowPart63:setAvoidScale(true);
    obj.flowPart63:setName("flowPart63");

    obj.edit39 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit39:setParent(obj.flowPart63);
    obj.edit39:setAlign("top");
    obj.edit39:setField("dexNivel");
    ...
    obj.horzLine37:setParent(obj.flowPart63);
    ...
    obj.flowPart64:setMaxScaledWidth(50);

    obj.image16 = GUI.fromHandle(_obj_newObject("image"));
    obj.image16:setParent(obj.flowPart64);
    ...
    obj.flowPart65:setMinWidth(30);
    obj.flowPart65:setMaxWidth(35);
    obj.flowPart65:setMaxScaledWidth(35);
    ...
    obj.horzLine38:setParent(obj.flowPart65);
    ...
    obj.flowPart66:setMaxScaledWidth(50);

    obj.image17 = GUI.fromHandle(_obj_newObject("image"));
    obj.image17:setParent(obj.flowPart66);
    ...
    obj.flowPart67:setMaxWidth(35);
    obj.flowPart67:setMaxScaledWidth(35);
    ...
    obj.horzLine39:setParent(obj.flowPart67);
    ...
    obj.flowPart68:setMaxScaledWidth(50);

    obj.image18 = GUI.fromHandle(_obj_newObject("image"));
    obj.image18:setParent(obj.flowPart68);
    ...
    obj.flowPart69:setMaxWidth(35);
    obj.flowPart69:setMaxScaledWidth(35);
    ...
    obj.horzLine40:setParent(obj.flowPart69);
    ...
    obj.flowPart70:setMaxScaledWidth(50);

    obj.image19 = GUI.fromHandle(_obj_newObject("image"));
    obj.image19:setParent(obj.flowPart70);
    ...
    obj.flowPart71:setMaxWidth(35);
    obj.flowPart71:setMaxScaledWidth(35);
    obj.flowPart71:setAvoidScale(true);
    obj.flowPart71:setName("flowPart71");

    obj.edit43 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit43:setParent(obj.flowPart71);
    obj.edit43:setAlign("top");
    obj.edit43:setField("dexOutros");
    ...
    obj.horzLine41:setParent(obj.flowPart71);
    ...
    obj.flowPart72:setMaxScaledWidth(50);

    obj.image20 = GUI.fromHandle(_obj_newObject("image"));
    obj.image20:setParent(obj.flowPart72);
    ...
    obj.flowPart73:setMaxWidth(35);
    obj.flowPart73:setMaxScaledWidth(35);
    obj.flowPart73:setAvoidScale(true);
    obj.flowPart73:setName("flowPart73");

    obj.edit44 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit44:setParent(obj.flowPart73);
    obj.edit44:setAlign("top");
    obj.edit44:setField("dexBase");
    ...
    obj.horzLine42:setParent(obj.flowPart73);
    ...
    obj.flowPart74:setMaxScaledWidth(50);

    obj.image21 = GUI.fromHandle(_obj_newObject("image"));
    obj.image21:setParent(obj.flowPart74);
    ...
    obj.flowPart75:setMaxScaledWidth(35);
    obj.flowPart75:setAvoidScale(true);
    obj.flowPart75:setName("flowPart75");

    obj.edit45 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit45:setParent(obj.flowPart75);
    obj.edit45:setAlign("top");
    obj.edit45:setField("dexEquip");
    ...
    obj.horzLine43:setParent(obj.flowPart75);
    ...
    obj.flowPart76:setMaxScaledWidth(50);

    obj.image22 = GUI.fromHandle(_obj_newObject("image"));
    obj.image22:setParent(obj.flowPart76);
    ...
    obj.flowPart77:setMinWidth(30);
    obj.flowPart77:setMaxWidth(35);
    obj.flowPart77:setMaxScaledWidth(35);
    obj.flowPart77:setAvoidScale(true);
    obj.flowPart77:setName("flowPart77");

    obj.edit46 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit46:setParent(obj.flowPart77);
    ...
    obj.horzLine44:setParent(obj.flowPart77);
    ...
    obj.flowPart78:setMinScaledWidth(60);
    obj.flowPart78:setMaxScaledWidth(85);
    obj.flowPart78:setName("flowPart78");

    obj.label49 = GUI.fromHandle(_obj_newObject("label"));
    obj.label49:setParent(obj.flowPart78);
    obj.label49:setText("Carisma");
    obj.label49:setAlign("client");
    obj.label49:setField("");
    obj.label49:setFontSize(8);
    ...
    obj.flowPart79:setMinWidth(30);
    obj.flowPart79:setMaxWidth(35);
    obj.flowPart79:setMaxScaledWidth(35);
    obj.flowPart79:setAvoidScale(true);
    obj.flowPart79:setName("flowPart79");

    obj.edit47 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit47:setParent(obj.flowPart79);
    ...
    obj.horzLine45:setParent(obj.flowPart79);
    ...
    obj.flowPart80:setMaxScaledWidth(50);

    obj.image23 = GUI.fromHandle(_obj_newObject("image"));
    obj.image23:setParent(obj.flowPart80);
    ...
    obj.flowPart81:setMinWidth(30);
    obj.flowPart81:setMaxWidth(35);
    obj.flowPart81:setMaxScaledWidth(35);
    ...
    obj.horzLine46:setParent(obj.flowPart81);
    ...
    obj.flowPart82:setMaxScaledWidth(50);

    obj.image24 = GUI.fromHandle(_obj_newObject("image"));
    obj.image24:setParent(obj.flowPart82);
    ...
    obj.flowPart83:setMinWidth(30);
    obj.flowPart83:setMaxWidth(35);
    obj.flowPart83:setMaxScaledWidth(35);
    obj.flowPart83:setAvoidScale(true);
    obj.flowPart83:setName("flowPart83");

    obj.edit49 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit49:setParent(obj.flowPart83);
    ...
    obj.horzLine47:setParent(obj.flowPart83);
    ...
    obj.flowPart84:setMaxScaledWidth(50);

    obj.image25 = GUI.fromHandle(_obj_newObject("image"));
    obj.image25:setParent(obj.flowPart84);
    ...
    obj.flowPart85:setMinWidth(30);
    obj.flowPart85:setMaxWidth(35);
    obj.flowPart85:setMaxScaledWidth(35);
    obj.flowPart85:setAvoidScale(true);
    obj.flowPart85:setName("flowPart85");

    obj.edit50 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit50:setParent(obj.flowPart85);
    ...
    obj.horzLine48:setParent(obj.flowPart85);
    ...
    obj.flowPart86:setMaxScaledWidth(50);

    obj.image26 = GUI.fromHandle(_obj_newObject("image"));
    obj.image26:setParent(obj.flowPart86);
    ...
    obj.flowPart87:setMinWidth(30);
    obj.flowPart87:setMaxWidth(35);
    obj.flowPart87:setMaxScaledWidth(35);
    obj.flowPart87:setAvoidScale(true);
    obj.flowPart87:setName("flowPart87");

    obj.edit51 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit51:setParent(obj.flowPart87);
    obj.edit51:setAlign("top");
    obj.edit51:setField("carOutros");
    ...
    obj.horzLine49:setParent(obj.flowPart87);
    ...
    obj.flowPart88:setMaxScaledWidth(50);

    obj.image27 = GUI.fromHandle(_obj_newObject("image"));
    obj.image27:setParent(obj.flowPart88);
    ...
    obj.flowPart89:setMinWidth(30);
    obj.flowPart89:setMaxWidth(35);
    obj.flowPart89:setMaxScaledWidth(35);
    obj.flowPart89:setAvoidScale(true);
    obj.flowPart89:setName("flowPart89");

    obj.edit52 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit52:setParent(obj.flowPart89);
    ...
    obj.horzLine50:setParent(obj.flowPart89);
    ...
    obj.flowPart90:setMaxScaledWidth(50);

    obj.image28 = GUI.fromHandle(_obj_newObject("image"));
    obj.image28:setParent(obj.flowPart90);
    ...
    obj.flowPart91:setMinWidth(30);
    obj.flowPart91:setMaxWidth(35);
    obj.flowPart91:setMaxScaledWidth(35);
    obj.flowPart91:setAvoidScale(true);
    obj.flowPart91:setName("flowPart91");

    obj.edit53 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit53:setParent(obj.flowPart91);
    obj.edit53:setAlign("top");
    obj.edit53:setField("carEquip");
    ...
    obj.horzLine51:setParent(obj.flowPart91);
    ...
    obj.flowPart92:setMaxScaledWidth(50);

    obj.image29 = GUI.fromHandle(_obj_newObject("image"));
    obj.image29:setParent(obj.flowPart92);
    ...
    obj.flowPart93:setMinWidth(30);
    obj.flowPart93:setMaxWidth(35);
    obj.flowPart93:setMaxScaledWidth(35);
    obj.flowPart93:setAvoidScale(true);
    obj.flowPart93:setName("flowPart93");

    obj.edit54 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit54:setParent(obj.flowPart93);
    ...
    obj.horzLine52:setParent(obj.flowPart93);
    ...
    obj.flowPart94:setMinScaledWidth(60);
    obj.flowPart94:setMaxScaledWidth(85);
    obj.flowPart94:setName("flowPart94");

    obj.label50 = GUI.fromHandle(_obj_newObject("label"));
    obj.label50:setParent(obj.flowPart94);
    obj.label50:setText("Inteligência");
    ...
    obj.flowPart95:setMinWidth(30);
    obj.flowPart95:setMaxWidth(35);
    obj.flowPart95:setMaxScaledWidth(35);
    obj.flowPart95:setAvoidScale(true);
    obj.flowPart95:setName("flowPart95");

    obj.edit55 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit55:setParent(obj.flowPart95);
    obj.edit55:setAlign("top");
    obj.edit55:setField("intNivel");
    ...
    obj.horzLine53:setParent(obj.flowPart95);
    ...
    obj.flowPart96:setMaxScaledWidth(50);

    obj.image30 = GUI.fromHandle(_obj_newObject("image"));
    obj.image30:setParent(obj.flowPart96);
    ...
    obj.flowPart97:setMinWidth(30);
    obj.flowPart97:setMaxWidth(35);
    obj.flowPart97:setMaxScaledWidth(35);
    obj.flowPart97:setAvoidScale(true);
    obj.flowPart97:setName("flowPart97");

    obj.edit56 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit56:setParent(obj.flowPart97);
    obj.edit56:setAlign("top");
    obj.edit56:setField("intClasse");
    ...
    obj.horzLine54:setParent(obj.flowPart97);
    ...
    obj.flowPart98:setMaxScaledWidth(50);

    obj.image31 = GUI.fromHandle(_obj_newObject("image"));
    obj.image31:setParent(obj.flowPart98);
    ...
    obj.flowPart99:setMinWidth(30);
    obj.flowPart99:setMaxWidth(35);
    obj.flowPart99:setMaxScaledWidth(35);
    obj.flowPart99:setAvoidScale(true);
    obj.flowPart99:setName("flowPart99");

    obj.edit57 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit57:setParent(obj.flowPart99);
    obj.edit57:setAlign("top");
    obj.edit57:setField("intRaca");
    ...
    obj.horzLine55:setParent(obj.flowPart99);
    ...
    obj.flowPart100:setMaxScaledWidth(50);

    obj.image32 = GUI.fromHandle(_obj_newObject("image"));
    obj.image32:setParent(obj.flowPart100);
    ...
    obj.flowPart101:setMinWidth(30);
    obj.flowPart101:setMaxWidth(35);
    obj.flowPart101:setMaxScaledWidth(35);
    obj.flowPart101:setAvoidScale(true);
    obj.flowPart101:setName("flowPart101");

    obj.edit58 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit58:setParent(obj.flowPart101);
    obj.edit58:setAlign("top");
    obj.edit58:setField("intTreino");
    ...
    obj.horzLine56:setParent(obj.flowPart101);
    ...
    obj.flowPart102:setMaxScaledWidth(50);

    obj.image33 = GUI.fromHandle(_obj_newObject("image"));
    obj.image33:setParent(obj.flowPart102);
    ...
    obj.flowPart103:setMinWidth(30);
    obj.flowPart103:setMaxWidth(35);
    obj.flowPart103:setMaxScaledWidth(35);
    obj.flowPart103:setAvoidScale(true);
    obj.flowPart103:setName("flowPart103");

    obj.edit59 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit59:setParent(obj.flowPart103);
    obj.edit59:setAlign("top");
    obj.edit59:setField("intOutros");
    ...
    obj.horzLine57:setParent(obj.flowPart103);
    ...
    obj.flowPart104:setMaxScaledWidth(50);

    obj.image34 = GUI.fromHandle(_obj_newObject("image"));
    obj.image34:setParent(obj.flowPart104);
    ...
    obj.flowPart105:setMinWidth(30);
    obj.flowPart105:setMaxWidth(35);
    obj.flowPart105:setMaxScaledWidth(35);
    obj.flowPart105:setAvoidScale(true);
    obj.flowPart105:setName("flowPart105");

    obj.edit60 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit60:setParent(obj.flowPart105);
    obj.edit60:setAlign("top");
    obj.edit60:setField("intBase");
    ...
    obj.horzLine58:setParent(obj.flowPart105);
    ...
    obj.flowPart106:setMaxScaledWidth(50);

    obj.image35 = GUI.fromHandle(_obj_newObject("image"));
    obj.image35:setParent(obj.flowPart106);
    ...
    obj.flowPart107:setMinWidth(30);
    obj.flowPart107:setMaxWidth(35);
    obj.flowPart107:setMaxScaledWidth(35);
    obj.flowPart107:setAvoidScale(true);
    obj.flowPart107:setName("flowPart107");

    obj.edit61 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit61:setParent(obj.flowPart107);
    obj.edit61:setAlign("top");
    obj.edit61:setField("intEquip");
    ...
    obj.horzLine59:setParent(obj.flowPart107);
    ...
    obj.flowPart108:setMaxScaledWidth(50);

    obj.image36 = GUI.fromHandle(_obj_newObject("image"));
    obj.image36:setParent(obj.flowPart108);
    ...
    obj.flowPart109:setMinWidth(30);
    obj.flowPart109:setMaxWidth(35);
    obj.flowPart109:setMaxScaledWidth(35);
    obj.flowPart109:setAvoidScale(true);
    obj.flowPart109:setName("flowPart109");

    obj.edit62 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit62:setParent(obj.flowPart109);
    obj.edit62:setAlign("top");
    obj.edit62:setField("intTotal");
    ...
    obj.horzLine60:setParent(obj.flowPart109);
    ...
    obj.flowPart110:setMinScaledWidth(60);
    obj.flowPart110:setMaxScaledWidth(85);
    obj.flowPart110:setName("flowPart110");

    obj.label51 = GUI.fromHandle(_obj_newObject("label"));
    obj.label51:setParent(obj.flowPart110);
    obj.label51:setText("Sabedoria");
    ...
    obj.flowPart111:setMaxWidth(35);
    obj.flowPart111:setMaxScaledWidth(35);
    obj.flowPart111:setAvoidScale(true);
    obj.flowPart111:setName("flowPart111");

    obj.edit63 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit63:setParent(obj.flowPart111);
    obj.edit63:setAlign("top");
    obj.edit63:setField("sabNivel");
    ...
    obj.horzLine61:setParent(obj.flowPart111);
    ...
    obj.flowPart112:setMaxScaledWidth(50);

    obj.image37 = GUI.fromHandle(_obj_newObject("image"));
    obj.image37:setParent(obj.flowPart112);
    ...
    obj.flowPart113:setMinWidth(30);
    obj.flowPart113:setMaxWidth(35);
    obj.flowPart113:setMaxScaledWidth(35);
    obj.flowPart113:setAvoidScale(true);
    obj.flowPart113:setName("flowPart113");

    obj.edit64 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit64:setParent(obj.flowPart113);
    obj.edit64:setAlign("top");
    obj.edit64:setField("sabClasse");
    ...
    obj.horzLine62:setParent(obj.flowPart113);
    ...
    obj.flowPart114:setMaxScaledWidth(50);

    obj.image38 = GUI.fromHandle(_obj_newObject("image"));
    obj.image38:setParent(obj.flowPart114);
    ...
    obj.flowPart115:setMinWidth(30);
    obj.flowPart115:setMaxWidth(35);
    obj.flowPart115:setMaxScaledWidth(35);
    obj.flowPart115:setAvoidScale(true);
    obj.flowPart115:setName("flowPart115");

    obj.edit65 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit65:setParent(obj.flowPart115);
    obj.edit65:setAlign("top");
    obj.edit65:setField("sabRaca");
    ...
    obj.horzLine63:setParent(obj.flowPart115);
    ...
    obj.flowPart116:setMaxScaledWidth(50);

    obj.image39 = GUI.fromHandle(_obj_newObject("image"));
    obj.image39:setParent(obj.flowPart116);
    ...
    obj.flowPart117:setMinWidth(30);
    obj.flowPart117:setMaxWidth(35);
    obj.flowPart117:setMaxScaledWidth(35);
    obj.flowPart117:setAvoidScale(true);
    obj.flowPart117:setName("flowPart117");

    obj.edit66 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit66:setParent(obj.flowPart117);
    obj.edit66:setAlign("top");
    obj.edit66:setField("sabTreino");
    ...
    obj.horzLine64:setParent(obj.flowPart117);
    ...
    obj.flowPart118:setMaxScaledWidth(50);

    obj.image40 = GUI.fromHandle(_obj_newObject("image"));
    obj.image40:setParent(obj.flowPart118);
    ...
    obj.flowPart119:setMinWidth(30);
    obj.flowPart119:setMaxWidth(35);
    obj.flowPart119:setMaxScaledWidth(35);
    obj.flowPart119:setAvoidScale(true);
    obj.flowPart119:setName("flowPart119");

    obj.edit67 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit67:setParent(obj.flowPart119);
    obj.edit67:setAlign("top");
    obj.edit67:setField("sabOutros");
    ...
    obj.horzLine65:setParent(obj.flowPart119);
    ...
    obj.flowPart120:setMaxScaledWidth(50);

    obj.image41 = GUI.fromHandle(_obj_newObject("image"));
    obj.image41:setParent(obj.flowPart120);
    ...
    obj.flowPart121:setMinWidth(30);
    obj.flowPart121:setMaxWidth(35);
    obj.flowPart121:setMaxScaledWidth(35);
    obj.flowPart121:setAvoidScale(true);
    obj.flowPart121:setName("flowPart121");

    obj.edit68 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit68:setParent(obj.flowPart121);
    obj.edit68:setAlign("top");
    obj.edit68:setField("sabBase");
    ...
    obj.horzLine66:setParent(obj.flowPart121);
    ...
    obj.flowPart122:setMaxScaledWidth(50);

    obj.image42 = GUI.fromHandle(_obj_newObject("image"));
    obj.image42:setParent(obj.flowPart122);
    ...
    obj.flowPart123:setMinWidth(30);
    obj.flowPart123:setMaxWidth(35);
    obj.flowPart123:setMaxScaledWidth(35);
    obj.flowPart123:setAvoidScale(true);
    obj.flowPart123:setName("flowPart123");

    obj.edit69 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit69:setParent(obj.flowPart123);
    obj.edit69:setAlign("top");
    obj.edit69:setField("sabEquip");
    ...
    obj.horzLine67:setParent(obj.flowPart123);
    ...
    obj.flowPart124:setMaxScaledWidth(50);

    obj.image43 = GUI.fromHandle(_obj_newObject("image"));
    obj.image43:setParent(obj.flowPart124);
    ...
    obj.flowPart125:setMinWidth(30);
    obj.flowPart125:setMaxWidth(35);
    obj.flowPart125:setMaxScaledWidth(35);
    obj.flowPart125:setAvoidScale(true);
    obj.flowPart125:setName("flowPart125");

    obj.edit70 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit70:setParent(obj.flowPart125);
    ...
    obj.horzLine68:setParent(obj.flowPart125);
    ...
    obj.flowPart126:setParent(obj.perfilLayout);
    obj.flowPart126:setHeight(2);
    obj.flowPart126:setMinScaledWidth(100);
    obj.flowPart126:setMaxScaledWidth(1600);
    obj.flowPart126:setName("flowPart126");

    obj.horzLine69 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine69:setParent(obj.flowPart126);
    obj.horzLine69:setStrokeColor("#FFFFFF50");
    obj.horzLine69:setStrokeSize(0.6);
    obj.horzLine69:setStrokeCap("round");
    obj.horzLine69:setScaleY(0.1);
    obj.horzLine69:setTop(1);
    ...
    obj.label52:setParent(obj.topoPtBonusEConhecimentos);
    obj.label52:setText("Pontos Restantes: ");
    obj.label52:setWidth(150);
    obj.label52:setName("label52");

    obj.edit71 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit71:setParent(obj.topoPtBonusEConhecimentos);
    obj.edit71:setAlign("client");
    obj.edit71:setField("pontosRestantes");
    ...
    obj.label53:setParent(obj.topoPtBonusEConhecimentos);
    obj.label53:setText("Pontos Treinados: ");
    obj.label53:setWidth(150);
    obj.label53:setName("label53");

    obj.edit72 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit72:setParent(obj.topoPtBonusEConhecimentos);
    obj.edit72:setAlign("client");
    obj.edit72:setField("pontosTreinados");
    ...
    obj.label54:setParent(obj.topoPtBonusEConhecimentos);
    obj.label54:setText("Pontos de Conhecimento: ");
    obj.label54:setWidth(150);
    obj.label54:setName("label54");

    obj.edit73 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit73:setParent(obj.topoPtBonusEConhecimentos);
    obj.edit73:setAlign("client");
    obj.edit73:setField("pontosDeConhecimento");
    ...
    obj.label55:setParent(obj.topoPtBonusEConhecimentos);
    obj.label55:setText("Pontos Con. Distribuidos: ");
    obj.label55:setWidth(150);
    obj.label55:setName("label55");

    obj.edit74 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit74:setParent(obj.topoPtBonusEConhecimentos);
    obj.edit74:setAlign("client");
    obj.edit74:setField("pontosDeConhecimentoDistribuidos");
    ...
    obj.flowPart127:setParent(obj.tabelaPontosBonus);
    ...
    obj.flowPart127:setMargins({top=5, bottom=5,right=10});

    obj.label56 = GUI.fromHandle(_obj_newObject("label"));
    obj.label56:setParent(obj.flowPart127);
    ...
    obj.horzLine70:setParent(obj.flowPart127);
    ...
    obj.percepcaoMinus:setParent(obj.flowLayout15);
    ...
    obj.flowPart128:setParent(obj.flowLayout15);
    obj.flowPart128:setHeight(20);
    obj.flowPart128:setMinWidth(20);
    obj.flowPart128:setMaxWidth(20);
    obj.flowPart128:setName("flowPart128");

    obj.edit75 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit75:setParent(obj.flowPart128);
    obj.edit75:setAlign("client");
    obj.edit75:setField("percepcao");
    ...
    obj.percepcaoPlus:setParent(obj.flowLayout15);
    ...
    obj.flowPart129:setParent(obj.tabelaPontosBonus);
    ...
    obj.flowPart129:setMargins({top=5, bottom=5,right=10});

    obj.label57 = GUI.fromHandle(_obj_newObject("label"));
    obj.label57:setParent(obj.flowPart129);
    obj.label57:setText("Intimidação");
    ...
    obj.horzLine71:setParent(obj.flowPart129);
    ...
    obj.intimidacaoMinus:setParent(obj.flowLayout16);
    ...
    obj.flowPart130:setParent(obj.flowLayout16);
    obj.flowPart130:setHeight(20);
    obj.flowPart130:setMinWidth(20);
    obj.flowPart130:setMaxWidth(20);
    obj.flowPart130:setName("flowPart130");

    obj.edit76 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit76:setParent(obj.flowPart130);
    obj.edit76:setAlign("client");
    obj.edit76:setField("intimidacao");
    ...
    obj.intimidacaoPlus:setParent(obj.flowLayout16);
    ...
    obj.flowPart131:setParent(obj.tabelaPontosBonus);
    ...
    obj.flowPart131:setMargins({top=5, bottom=5,right=10});

    obj.label58 = GUI.fromHandle(_obj_newObject("label"));
    obj.label58:setParent(obj.flowPart131);
    obj.label58:setText("Persuasão");
    obj.label58:setAlign("left");
    obj.label58:setFontSize(18);
    obj.label58:setVertTextAlign("center");
    obj.label58:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label58, "fontStyle",  "italic");
    obj.label58:setWidth(200);
    obj.label58:setName("label58");

    obj.horzLine72 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine72:setParent(obj.flowPart131);
    ...
    obj.flowLayout17:setParent(obj.tabelaPontosBonus);
    ...
    obj.persuasaoMinus:setParent(obj.flowLayout17);
    ...
    obj.flowPart132:setParent(obj.flowLayout17);
    obj.flowPart132:setHeight(20);
    obj.flowPart132:setMinWidth(20);
    obj.flowPart132:setMaxWidth(20);
    obj.flowPart132:setName("flowPart132");

    obj.edit77 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit77:setParent(obj.flowPart132);
    obj.edit77:setAlign("client");
    obj.edit77:setField("persuasao");
    ...
    obj.persuasaoPlus:setParent(obj.flowLayout17);
    ...
    obj.flowPart133:setParent(obj.tabelaPontosBonus);
    ...
    obj.flowPart133:setMargins({top=5, bottom=5,right=10});

    obj.label59 = GUI.fromHandle(_obj_newObject("label"));
    obj.label59:setParent(obj.flowPart133);
    obj.label59:setText("Adestrar Animais");
    obj.label59:setAlign("left");
    obj.label59:setFontSize(18);
    obj.label59:setVertTextAlign("center");
    obj.label59:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label59, "fontStyle",  "italic");
    obj.label59:setWidth(200);
    obj.label59:setName("label59");

    obj.horzLine73 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine73:setParent(obj.flowPart133);
    ...
    obj.flowLayout18:setParent(obj.tabelaPontosBonus);
    ...
    obj.adestrarAnimaisMinus:setParent(obj.flowLayout18);
    ...
    obj.flowPart134:setParent(obj.flowLayout18);
    obj.flowPart134:setHeight(20);
    obj.flowPart134:setMinWidth(20);
    obj.flowPart134:setMaxWidth(20);
    obj.flowPart134:setName("flowPart134");

    obj.edit78 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit78:setParent(obj.flowPart134);
    obj.edit78:setAlign("client");
    obj.edit78:setField("adestrarAnimais");
    ...
    obj.adestrarAnimaisPlus:setParent(obj.flowLayout18);
    ...
    obj.flowPart135:setParent(obj.tabelaPontosBonus);
    obj.flowPart135:setHeight(20);
    obj.flowPart135:setMinWidth(180);
    obj.flowPart135:setMaxWidth(180);
    obj.flowPart135:setName("flowPart135");
    obj.flowPart135:setMargins({top=5, bottom=5,right=10});

    obj.label60 = GUI.fromHandle(_obj_newObject("label"));
    obj.label60:setParent(obj.flowPart135);
    ...
    lfm_setPropAsString(obj.label60, "fontStyle",  "italic");
    obj.label60:setWidth(200);
    obj.label60:setName("label60");

    obj.horzLine74 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine74:setParent(obj.flowPart135);
    ...
    obj.flowLayout19:setParent(obj.tabelaPontosBonus);
    ...
    obj.furtividadeMinus:setParent(obj.flowLayout19);
    ...
    obj.flowPart136:setParent(obj.flowLayout19);
    obj.flowPart136:setHeight(20);
    obj.flowPart136:setMinWidth(20);
    obj.flowPart136:setMaxWidth(20);
    obj.flowPart136:setName("flowPart136");

    obj.edit79 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit79:setParent(obj.flowPart136);
    obj.edit79:setAlign("client");
    obj.edit79:setField("furtividade");
    ...
    obj.furtividadePlus:setParent(obj.flowLayout19);
    ...
    obj.flowPart137:setParent(obj.tabelaPontosBonus);
    obj.flowPart137:setHeight(20);
    obj.flowPart137:setMinWidth(180);
    obj.flowPart137:setMaxWidth(180);
    obj.flowPart137:setName("flowPart137");
    obj.flowPart137:setMargins({top=5, bottom=5,right=10});

    obj.label61 = GUI.fromHandle(_obj_newObject("label"));
    obj.label61:setParent(obj.flowPart137);
    obj.label61:setText("Intuição");
    obj.label61:setAlign("left");
    obj.label61:setFontSize(18);
    obj.label61:setVertTextAlign("center");
    obj.label61:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label61, "fontStyle",  "italic");
    obj.label61:setWidth(200);
    obj.label61:setName("label61");

    obj.horzLine75 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine75:setParent(obj.flowPart137);
    ...
    obj.flowLayout20:setParent(obj.tabelaPontosBonus);
    ...
    obj.intuicaoMinus:setParent(obj.flowLayout20);
    ...
    obj.flowPart138:setParent(obj.flowLayout20);
    obj.flowPart138:setHeight(20);
    obj.flowPart138:setMinWidth(20);
    obj.flowPart138:setMaxWidth(20);
    obj.flowPart138:setName("flowPart138");

    obj.edit80 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit80:setParent(obj.flowPart138);
    obj.edit80:setAlign("client");
    obj.edit80:setField("intuicao");
    ...
    obj.intuicaoPlus:setParent(obj.flowLayout20);
    ...
    obj.flowPart139:setParent(obj.tabelaPontosBonus);
    obj.flowPart139:setHeight(20);
    obj.flowPart139:setMinWidth(180);
    obj.flowPart139:setMaxWidth(180);
    obj.flowPart139:setName("flowPart139");
    obj.flowPart139:setMargins({top=5, bottom=5,right=10});

    obj.label62 = GUI.fromHandle(_obj_newObject("label"));
    obj.label62:setParent(obj.flowPart139);
    obj.label62:setText("Didática");
    obj.label62:setAlign("left");
    obj.label62:setFontSize(18);
    obj.label62:setVertTextAlign("center");
    obj.label62:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label62, "fontStyle",  "italic");
    obj.label62:setWidth(200);
    obj.label62:setName("label62");

    obj.horzLine76 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine76:setParent(obj.flowPart139);
    ...
    obj.flowLayout21:setParent(obj.tabelaPontosBonus);
    ...
    obj.didaticaMinus:setParent(obj.flowLayout21);
    ...
    obj.flowPart140:setParent(obj.flowLayout21);
    obj.flowPart140:setHeight(20);
    obj.flowPart140:setMinWidth(20);
    obj.flowPart140:setMaxWidth(20);
    obj.flowPart140:setName("flowPart140");

    obj.edit81 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit81:setParent(obj.flowPart140);
    obj.edit81:setAlign("client");
    obj.edit81:setField("didatica");
    ...
    obj.didaticaPlus:setParent(obj.flowLayout21);
    ...
    obj.flowPart141:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart141:setHeight(20);
    obj.flowPart141:setMinWidth(180);
    obj.flowPart141:setMaxWidth(180);
    obj.flowPart141:setName("flowPart141");
    obj.flowPart141:setMargins({top=5, bottom=5,right=10});

    obj.label63 = GUI.fromHandle(_obj_newObject("label"));
    obj.label63:setParent(obj.flowPart141);
    obj.label63:setText("Geografia");
    obj.label63:setAlign("left");
    obj.label63:setFontSize(18);
    obj.label63:setVertTextAlign("center");
    obj.label63:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label63, "fontStyle",  "italic");
    obj.label63:setWidth(200);
    obj.label63:setName("label63");

    obj.horzLine77 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine77:setParent(obj.flowPart141);
    ...
    obj.geografiaMinus:setParent(obj.flowLayout22);
    ...
    obj.flowPart142:setParent(obj.flowLayout22);
    ...
    obj.edit82:setParent(obj.flowPart142);
    obj.edit82:setAlign("client");
    obj.edit82:setField("geografia");
    ...
    obj.geografiaPlus:setParent(obj.flowLayout22);
    ...
    obj.flowPart143:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart143:setHeight(20);
    obj.flowPart143:setMinWidth(180);
    obj.flowPart143:setMaxWidth(180);
    obj.flowPart143:setName("flowPart143");
    obj.flowPart143:setMargins({top=5, bottom=5,right=10});

    obj.label64 = GUI.fromHandle(_obj_newObject("label"));
    obj.label64:setParent(obj.flowPart143);
    obj.label64:setText("História");
    obj.label64:setAlign("left");
    obj.label64:setFontSize(18);
    obj.label64:setVertTextAlign("center");
    obj.label64:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label64, "fontStyle",  "italic");
    obj.label64:setWidth(200);
    obj.label64:setName("label64");

    obj.horzLine78 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine78:setParent(obj.flowPart143);
    ...
    obj.historiaMinus:setParent(obj.flowLayout23);
    ...
    obj.flowPart144:setParent(obj.flowLayout23);
    obj.flowPart144:setHeight(20);
    obj.flowPart144:setMinWidth(20);
    obj.flowPart144:setMaxWidth(20);
    obj.flowPart144:setName("flowPart144");

    obj.edit83 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit83:setParent(obj.flowPart144);
    obj.edit83:setAlign("client");
    obj.edit83:setField("historia");
    ...
    obj.historiaPlus:setParent(obj.flowLayout23);
    ...
    obj.flowPart145:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart145:setHeight(20);
    obj.flowPart145:setMinWidth(180);
    obj.flowPart145:setMaxWidth(180);
    obj.flowPart145:setName("flowPart145");
    obj.flowPart145:setMargins({top=5, bottom=5,right=10});

    obj.label65 = GUI.fromHandle(_obj_newObject("label"));
    obj.label65:setParent(obj.flowPart145);
    obj.label65:setText("Religião");
    obj.label65:setAlign("left");
    obj.label65:setFontSize(18);
    obj.label65:setVertTextAlign("center");
    obj.label65:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label65, "fontStyle",  "italic");
    obj.label65:setWidth(200);
    obj.label65:setName("label65");

    obj.horzLine79 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine79:setParent(obj.flowPart145);
    ...
    obj.religiaoMinus:setParent(obj.flowLayout24);
    ...
    obj.flowPart146:setParent(obj.flowLayout24);
    obj.flowPart146:setHeight(20);
    obj.flowPart146:setMinWidth(20);
    obj.flowPart146:setMaxWidth(20);
    obj.flowPart146:setName("flowPart146");

    obj.edit84 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit84:setParent(obj.flowPart146);
    obj.edit84:setAlign("client");
    obj.edit84:setField("religiao");
    ...
    obj.religiaoPlus:setParent(obj.flowLayout24);
    ...
    obj.flowPart147:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart147:setHeight(20);
    obj.flowPart147:setMinWidth(180);
    obj.flowPart147:setMaxWidth(180);
    obj.flowPart147:setName("flowPart147");
    obj.flowPart147:setMargins({top=5, bottom=5,right=10});

    obj.label66 = GUI.fromHandle(_obj_newObject("label"));
    obj.label66:setParent(obj.flowPart147);
    ...
    obj.horzLine80:setParent(obj.flowPart147);
    ...
    obj.magiaMinus:setParent(obj.flowLayout25);
    ...
    obj.flowPart148:setParent(obj.flowLayout25);
    obj.flowPart148:setHeight(20);
    obj.flowPart148:setMinWidth(20);
    obj.flowPart148:setMaxWidth(20);
    obj.flowPart148:setName("flowPart148");

    obj.edit85 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit85:setParent(obj.flowPart148);
    obj.edit85:setAlign("client");
    obj.edit85:setField("magia");
    ...
    obj.magiaPlus:setParent(obj.flowLayout25);
    ...
    obj.flowPart149:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart149:setHeight(20);
    obj.flowPart149:setMinWidth(180);
    obj.flowPart149:setMaxWidth(180);
    obj.flowPart149:setName("flowPart149");
    obj.flowPart149:setMargins({top=5, bottom=5,right=10});

    obj.label67 = GUI.fromHandle(_obj_newObject("label"));
    obj.label67:setParent(obj.flowPart149);
    obj.label67:setText("Fauna/Flora");
    obj.label67:setAlign("left");
    obj.label67:setFontSize(18);
    obj.label67:setVertTextAlign("center");
    obj.label67:setHorzTextAlign("center");
    lfm_setPropAsString(obj.label67, "fontStyle",  "italic");
    obj.label67:setWidth(200);
    obj.label67:setName("label67");

    obj.horzLine81 = GUI.fromHandle(_obj_newObject("horzLine"));
    obj.horzLine81:setParent(obj.flowPart149);
    ...
    obj.faunafloraMinus:setParent(obj.flowLayout26);
    ...
    obj.flowPart150:setParent(obj.flowLayout26);
    obj.flowPart150:setHeight(20);
    obj.flowPart150:setMinWidth(20);
    obj.flowPart150:setMaxWidth(20);
    obj.flowPart150:setName("flowPart150");

    obj.edit86 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit86:setParent(obj.flowPart150);
    obj.edit86:setAlign("client");
    obj.edit86:setField("faunaflora");
    ...
    obj.faunafloraPlus:setParent(obj.flowLayout26);
    ...
    obj.flowPart151:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart151:setHeight(20);
    obj.flowPart151:setMinWidth(180);
    obj.flowPart151:setMaxWidth(180);
    obj.flowPart151:setName("flowPart151");
    obj.flowPart151:setMargins({top=5, bottom=5,right=10});

    obj.label68 = GUI.fromHandle(_obj_newObject("label"));
    obj.label68:setParent(obj.flowPart151);
    obj.label68:setText("Lng. Comum");
    ...
    obj.horzLine82:setParent(obj.flowPart151);
    ...
    obj.flowLayout27:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout27:setHeight(20);
    obj.flowLayout27:setMinWidth(150);
    obj.flowLayout27:setMaxWidth(200);
    ...
    obj.linguagemComumMinus:setParent(obj.flowLayout27);
    ...
    obj.flowPart152:setParent(obj.flowLayout27);
    obj.flowPart152:setHeight(20);
    obj.flowPart152:setMinWidth(20);
    obj.flowPart152:setMaxWidth(20);
    obj.flowPart152:setName("flowPart152");

    obj.edit87 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit87:setParent(obj.flowPart152);
    obj.edit87:setAlign("client");
    obj.edit87:setField("linguagemComum");
    ...
    obj.linguagemComumPlus:setParent(obj.flowLayout27);
    ...
    obj.flowPart153:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart153:setHeight(20);
    obj.flowPart153:setMinWidth(180);
    obj.flowPart153:setMaxWidth(180);
    obj.flowPart153:setName("flowPart153");
    obj.flowPart153:setMargins({top=5, bottom=5,right=10});

    obj.label69 = GUI.fromHandle(_obj_newObject("label"));
    obj.label69:setParent(obj.flowPart153);
    obj.label69:setText("Lng. Oriental");
    ...
    obj.flowLayout28:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout28:setHeight(20);
    obj.flowLayout28:setMinWidth(150);
    obj.flowLayout28:setMaxWidth(200);
    ...
    obj.linguagemOrientalMinus:setParent(obj.flowLayout28);
    ...
    obj.flowPart154:setParent(obj.flowLayout28);
    obj.flowPart154:setHeight(20);
    obj.flowPart154:setMinWidth(20);
    obj.flowPart154:setMaxWidth(20);
    obj.flowPart154:setName("flowPart154");

    obj.edit88 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit88:setParent(obj.flowPart154);
    obj.edit88:setAlign("client");
    obj.edit88:setField("linguagemOriental");
    ...
    obj.linguagemOrientalPlus:setParent(obj.flowLayout28);
    ...
    obj.flowPart155:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart155:setHeight(20);
    obj.flowPart155:setMinWidth(180);
    obj.flowPart155:setMaxWidth(180);
    obj.flowPart155:setName("flowPart155");
    obj.flowPart155:setMargins({top=5, bottom=5,right=10});

    obj.label70 = GUI.fromHandle(_obj_newObject("label"));
    obj.label70:setParent(obj.flowPart155);
    obj.label70:setText("Lng. Élfica");
    ...
    obj.horzLine84:setParent(obj.flowPart155);
    ...
    obj.flowLayout29:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout29:setHeight(20);
    obj.flowLayout29:setMinWidth(150);
    obj.flowLayout29:setMaxWidth(200);
    ...
    obj.linguagemElficaMinus:setParent(obj.flowLayout29);
    ...
    obj.flowPart156:setParent(obj.flowLayout29);
    obj.flowPart156:setHeight(20);
    obj.flowPart156:setMinWidth(20);
    obj.flowPart156:setMaxWidth(20);
    obj.flowPart156:setName("flowPart156");

    obj.edit89 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit89:setParent(obj.flowPart156);
    obj.edit89:setAlign("client");
    obj.edit89:setField("linguagemElfica");
    ...
    obj.linguagemElficaPlus:setParent(obj.flowLayout29);
    ...
    obj.flowPart157:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowPart157:setHeight(20);
    obj.flowPart157:setMinWidth(180);
    obj.flowPart157:setMaxWidth(180);
    obj.flowPart157:setName("flowPart157");
    obj.flowPart157:setMargins({top=5, bottom=5,right=10});

    obj.label71 = GUI.fromHandle(_obj_newObject("label"));
    obj.label71:setParent(obj.flowPart157);
    obj.label71:setText("Lng. Anã");
    ...
    obj.horzLine85:setParent(obj.flowPart157);
    ...
    obj.flowLayout30:setParent(obj.tabelaConhecimentosEspecificos);
    obj.flowLayout30:setHeight(20);
    obj.flowLayout30:setMinWidth(150);
    obj.flowLayout30:setMaxWidth(200);
    ...
    obj.linguagemAnaMinus:setParent(obj.flowLayout30);
    ...
    obj.flowPart158:setMinWidth(20);
    obj.flowPart158:setMaxWidth(20);
    obj.flowPart158:setName("flowPart158");

    obj.edit90 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit90:setParent(obj.flowPart158);
    obj.edit90:setAlign("client");
    obj.edit90:setField("linguagemAna");
    ...
    obj.linguagemAnaPlus:setParent(obj.flowLayout30);
    ...
    obj.flowPart159:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.flowPart159:setMargins({top=5, bottom=5,right=10});

    obj.label72 = GUI.fromHandle(_obj_newObject("label"));
    obj.label72:setParent(obj.flowPart159);
    obj.label72:setText("Lng. Dracônica");
    ...
    obj.horzLine86:setParent(obj.flowPart159);
    ...
    obj.flowLayout31:setParent(obj.tabelaConhecimentosEspecificos);
    ...
    obj.linguagemDraconicaMinus:setParent(obj.flowLayout31);
    ...
    obj.flowPart160:setMaxWidth(20);
    obj.flowPart160:setName("flowPart160");

    obj.edit91 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit91:setParent(obj.flowPart160);
    obj.edit91:setAlign("client");
    obj.edit91:setField("linguagemDraconica");
    ...
    obj.linguagemDraconicaPlus:setParent(obj.flowLayout31);
    ...
    obj.dataLink60:setParent(obj.rectangle11);
    ...
    obj._e_event0 = obj.button3:addEventListener("onClick",
        function (_)
            self.popuphab1:show()
        end, obj);
    ...
    obj._e_event2 = obj.button9:addEventListener("onClick",
        function (_)
            self.popuphab3:show()
        end, obj);

    obj._e_event3 = obj.button11:addEventListener("onClick",
        function (_)
    ...
    obj._e_event4 = obj.button12:addEventListener("onClick",
        function (_)
    ...
    obj._e_event5 = obj.button13:addEventListener("onClick",
        function (_)
            if sheet.pDestino == nil then sheet.pDestino = 0 end
                                                        sheet.pDestino = sheet.pDestino + 1
    ...
    obj._e_event10 = obj.barraxpClasse:addEventListener("onDblClick",
        function (_)
            self.popupxpClasse:show('bottomCenter', self.barraxpClasse)
                                             self.somaxpClasse:setFocus()
        end, obj);

    obj._e_event11 = obj.somaxpClasse:addEventListener("onKeyDown",
        function (_, event)
    ...
    obj._e_event12 = obj.okButtonClasse:addEventListener("onClick",
        function (_)
    ...
    obj._e_event13 = obj.barraxpProfissao:addEventListener("onDblClick",
        function (_)
            self.popupxpProfissao:show('bottomCenter', self.barraxpProfissao)
                                             self.somaxpProfissao:setFocus()
        end, obj);

    obj._e_event14 = obj.somaxpProfissao:addEventListener("onKeyDown",
        function (_, event)
    ...
    obj._e_event15 = obj.okButtonProfissao:addEventListener("onClick",
        function (_)
    ...
    obj._e_event20 = obj.dataLink9:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event25 = obj.dataLink14:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event26 = obj.dataLink15:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event29 = obj.dataLink18:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event31 = obj.dataLink20:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event37 = obj.dataLink26:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event39 = obj.dataLink28:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event41 = obj.dataLink30:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event49 = obj.dataLink38:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.carBase == nil then sheet.carBase = 0 end;
        end, obj);

    obj._e_event50 = obj.dataLink39:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.carEquip == nil then sheet.carEquip = 0 end;
        end, obj);

    obj._e_event51 = obj.dataLink40:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event60 = obj.dataLink49:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intTotal == nil then sheet.intTotal = 0 end;
        end, obj);

    obj._e_event61 = obj.dataLink50:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event62 = obj.dataLink51:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabNivel == nil then sheet.sabNivel = 0 end;
        end, obj);

    obj._e_event63 = obj.dataLink52:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabClasse == nil then sheet.sabClasse = 0 end;
        end, obj);

    obj._e_event64 = obj.dataLink53:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabRaca == nil then sheet.sabRaca = 0 end;
        end, obj);

    obj._e_event65 = obj.dataLink54:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabTreino == nil then sheet.sabTreino = 0 end;
        end, obj);

    obj._e_event66 = obj.dataLink55:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabOutros == nil then sheet.sabOutros = 0 end;
        end, obj);

    obj._e_event67 = obj.dataLink56:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabBase == nil then sheet.sabBase = 0 end;
        end, obj);

    obj._e_event68 = obj.dataLink57:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabEquip == nil then sheet.sabEquip = 0 end;
        end, obj);

    obj._e_event69 = obj.dataLink58:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabTotal == nil then sheet.sabTotal = 0 end;
        end, obj);

    obj._e_event70 = obj.dataLink59:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event71 = obj.percepcaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event72 = obj.percepcaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event73 = obj.intimidacaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event74 = obj.intimidacaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event75 = obj.persuasaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event76 = obj.persuasaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event77 = obj.adestrarAnimaisMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event78 = obj.adestrarAnimaisPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event79 = obj.furtividadeMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event80 = obj.furtividadePlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event81 = obj.intuicaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event82 = obj.intuicaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event83 = obj.didaticaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event84 = obj.didaticaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event85 = obj.geografiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event86 = obj.geografiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event87 = obj.historiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event88 = obj.historiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event89 = obj.religiaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event90 = obj.religiaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event91 = obj.magiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event92 = obj.magiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event93 = obj.faunafloraMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event94 = obj.faunafloraPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event95 = obj.linguagemComumMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event96 = obj.linguagemComumPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event97 = obj.linguagemOrientalMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event98 = obj.linguagemOrientalPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event99 = obj.linguagemElficaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event100 = obj.linguagemElficaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event101 = obj.linguagemAnaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event102 = obj.linguagemAnaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event103 = obj.linguagemDraconicaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event104 = obj.linguagemDraconicaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event105 = obj.dataLink60:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    function obj:destroy() 
        ...
        if self.hab3 ~= nil then self.hab3:destroy(); self.hab3 = nil; end;
        ...
        if self.popuphab1 ~= nil then self.popuphab1:destroy(); self.popuphab1 = nil; end;
        ...
        if self.hab1 ~= nil then self.hab1:destroy(); self.hab1 = nil; end;
        ...
        if self.popuphab2 ~= nil then self.popuphab2:destroy(); self.popuphab2 = nil; end;
        ...
        if self.hab2 ~= nil then self.hab2:destroy(); self.hab2 = nil; end;
        ...
        if self.popuphab3 ~= nil then self.popuphab3:destroy(); self.popuphab3 = nil; end;
