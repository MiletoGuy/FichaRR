...
local function constructNew_frmFichaDePersonagem()
    ...
    obj.button2:setParent(obj.habilidadesLayout);
    obj.button2:setHeight(25);
    obj.button2:setText("Nova Habilidade");
    ...
    obj.rclHabilidades:setParent(obj.habilidadesLayout);
    obj.rclHabilidades:setName("rclHabilidades");
    obj.rclHabilidades:setField("habilidades");
    obj.rclHabilidades:setTemplateForm("habilidadercl");
    obj.rclHabilidades:setWidth(400);
    ...
    obj.rectangle3:setParent(obj.imagemDoPersonagem);
    ...
    obj.button4:setParent(obj.dadosDeNivel);
    obj.button4:setText("-");
    ...
    obj.rectangle6:setParent(obj.dadosDeNivel);
    obj.rectangle6:setCornerType("bevel");
    obj.rectangle6:setAlign("client");
    obj.rectangle6:setYradius(100);
    ...
    obj.button5:setParent(obj.dadosDeNivel);
    obj.button5:setText("+");
    ...
    obj.horzLine10:setParent(obj.rectangle7);
    ...
    obj.rectangle8:setParent(obj.vidaEDefesa);
    ...
    obj.horzLine11:setParent(obj.rectangle8);
    ...
    obj.rectangle10:setMargins({top=2, bottom=2, left=2, right=2});
    ...
    obj.label22:setParent(obj.rectangle10);
    ...
    obj.rectangle11:setMargins({left=2.5});
    ...
    obj.rectangle13:setParent(obj.atributosDestreza);
    ...
    obj.dataLink60:setParent(obj.rectangle2);
    ...
    obj._e_event9 = obj.barraxpClasse:addEventListener("onDblClick",
        function (_)
            self.popupxpClasse:show('bottomCenter', self.barraxpClasse)
                                             self.somaxpClasse:setFocus()
        end, obj);

    obj._e_event10 = obj.somaxpClasse:addEventListener("onKeyDown",
        function (_, event)
    ...
    obj._e_event11 = obj.okButtonClasse:addEventListener("onClick",
        function (_)
    ...
    obj._e_event12 = obj.barraxpProfissao:addEventListener("onDblClick",
        function (_)
            self.popupxpProfissao:show('bottomCenter', self.barraxpProfissao)
                                             self.somaxpProfissao:setFocus()
        end, obj);

    obj._e_event13 = obj.somaxpProfissao:addEventListener("onKeyDown",
        function (_, event)
    ...
    obj._e_event14 = obj.okButtonProfissao:addEventListener("onClick",
        function (_)
    ...
    obj._e_event23 = obj.dataLink13:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.conTotal == nil then sheet.conTotal = 0 end;
        end, obj);

    obj._e_event24 = obj.dataLink14:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event25 = obj.dataLink15:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.forNivel == nil then sheet.forNivel = 0 end;
        end, obj);

    obj._e_event26 = obj.dataLink16:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event33 = obj.dataLink23:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event35 = obj.dataLink25:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.dexClasse == nil then sheet.dexClasse = 0 end;
        end, obj);

    obj._e_event36 = obj.dataLink26:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.dexRaca == nil then sheet.dexRaca = 0 end;
        end, obj);

    obj._e_event37 = obj.dataLink27:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.dexTreino == nil then sheet.dexTreino = 0 end;
        end, obj);

    obj._e_event38 = obj.dataLink28:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event43 = obj.dataLink33:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.carNivel == nil then sheet.carNivel = 0 end;
        end, obj);

    obj._e_event44 = obj.dataLink34:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.carClasse == nil then sheet.carClasse = 0 end;
        end, obj);

    obj._e_event45 = obj.dataLink35:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.carRaca == nil then sheet.carRaca = 0 end;
        end, obj);

    obj._e_event46 = obj.dataLink36:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event55 = obj.dataLink45:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intTreino == nil then sheet.intTreino = 0 end;
        end, obj);

    obj._e_event56 = obj.dataLink46:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intOutros == nil then sheet.intOutros = 0 end;
        end, obj);

    obj._e_event57 = obj.dataLink47:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intBase == nil then sheet.intBase = 0 end;
        end, obj);

    obj._e_event58 = obj.dataLink48:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intEquip == nil then sheet.intEquip = 0 end;
        end, obj);

    obj._e_event59 = obj.dataLink49:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.intTotal == nil then sheet.intTotal = 0 end;
        end, obj);

    obj._e_event60 = obj.dataLink50:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event61 = obj.dataLink51:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabNivel == nil then sheet.sabNivel = 0 end;
        end, obj);

    obj._e_event62 = obj.dataLink52:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabClasse == nil then sheet.sabClasse = 0 end;
        end, obj);

    obj._e_event63 = obj.dataLink53:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabRaca == nil then sheet.sabRaca = 0 end;
        end, obj);

    obj._e_event64 = obj.dataLink54:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabTreino == nil then sheet.sabTreino = 0 end;
        end, obj);

    obj._e_event65 = obj.dataLink55:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabOutros == nil then sheet.sabOutros = 0 end;
        end, obj);

    obj._e_event66 = obj.dataLink56:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabBase == nil then sheet.sabBase = 0 end;
        end, obj);

    obj._e_event67 = obj.dataLink57:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabEquip == nil then sheet.sabEquip = 0 end;
        end, obj);

    obj._e_event68 = obj.dataLink58:addEventListener("onChange",
        function (_, field, oldValue, newValue)
            if sheet.sabTotal == nil then sheet.sabTotal = 0 end;
        end, obj);

    obj._e_event69 = obj.dataLink59:addEventListener("onChange",
        function (_, field, oldValue, newValue)
    ...
    obj._e_event70 = obj.percepcaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event71 = obj.percepcaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event72 = obj.intimidacaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event73 = obj.intimidacaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event74 = obj.persuasaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event75 = obj.persuasaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event76 = obj.adestrarAnimaisMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event77 = obj.adestrarAnimaisPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event78 = obj.furtividadeMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event79 = obj.furtividadePlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event80 = obj.intuicaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event81 = obj.intuicaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event82 = obj.didaticaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event83 = obj.didaticaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event84 = obj.geografiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event85 = obj.geografiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event86 = obj.historiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event87 = obj.historiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event88 = obj.religiaoMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event89 = obj.religiaoPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event90 = obj.magiaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event91 = obj.magiaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event92 = obj.faunafloraMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event93 = obj.faunafloraPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event94 = obj.linguagemComumMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event95 = obj.linguagemComumPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event96 = obj.linguagemOrientalMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event97 = obj.linguagemOrientalPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event98 = obj.linguagemElficaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event99 = obj.linguagemElficaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event100 = obj.linguagemAnaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event101 = obj.linguagemAnaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event102 = obj.linguagemDraconicaMinus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event103 = obj.linguagemDraconicaPlus:addEventListener("onClick",
        function (_)
    ...
    obj._e_event104 = obj.dataLink60:addEventListener("onChange",
        function (_, field, oldValue, newValue)
